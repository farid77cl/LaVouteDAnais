...
def get_ultra_lite_context():
    ...
    # Extraer solo párrafos con cambios (italización o Loyaltty)
...
print('Iniciando Auditoría ULTRA LITE del Centinela para el CAPÍTULO 1...')
...
try:
    ...
    report_path = os.path.join(os.getcwd(), 'reporte_centinela_cap1_ultra_lite.txt')
