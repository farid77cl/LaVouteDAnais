...
MODEL = 'qwen2.5-7b-instruct-1m' # Reintento con el modelo por defecto en los scripts
...
# User Prompt (Simplificado para evitar 400 por tamaño/contexto)
user_message = f"""
AUDITORÍA DE CAPÍTULO 1 REQUERIDA.
Actúa como el Agente Crítico de La Voûte d'Anaïs siguiendo el Códice Psicofísico.
...
print(f"Enviando auditoría simplificada a LM Studio (Modelo: {MODEL})...")
try:
    ...
    if resp.status_code != 200:
        ...
        # Guardar reporte
        report_path = r'C:\Users\fabara\LaVouteDAnais\99_Sistema\reportes\audit_result_real_light.md'
