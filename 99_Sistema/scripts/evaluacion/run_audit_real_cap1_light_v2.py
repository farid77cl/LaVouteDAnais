...
# User Prompt (Solo Capítulo 1 para evitar 400 por tamaño/contexto)
user_message = f"""
AUDITORÍA DE CAPÍTULO 1 REQUERIDA.
Agente Crítico: Evalúa el Capítulo 1 de 'Smart Home Stepford' v3.0 siguiendo el rigor literario del Códice Psicofísico.
...
print(f"Enviando auditoría LIGERA a LM Studio (Modelo: {MODEL})...")
try:
    ...
    if resp.status_code != 200:
        ...
        # Guardar reporte
        report_path = r'C:\Users\fabara\LaVouteDAnais\99_Sistema\reportes\audit_result_real_light_v2.md'
