...
def test_miss_doll_numera_pelado():
    assert N.nombre_archivo(10, "seated", CFG["miss_doll"]) == "miss_doll_10_seated.png"


def test_anais_numera_con_L_y_dos_digitos():
    assert N.nombre_archivo(9, "standing", CFG["anais"]) == "anais_L09_standing.png"


def test_el_slot5_usa_el_slug_de_cada_muneca_en_el_archivo():
    assert N.nombre_archivo(800, "slot5", CFG["ele"]) == "ele_800_ditzy.png"
    assert N.nombre_archivo(9, "slot5", CFG["anais"]) == "anais_L09_sovereign_gaze.png"
    assert N.nombre_archivo(10, "slot5", CFG["miss_doll"]) == "miss_doll_10_glacial_command.png"
