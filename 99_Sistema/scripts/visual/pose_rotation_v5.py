...
DITZY = [
 "waist-up shot framed from the waist up, the torso angled and the augmented bust pushed forward and presented to the camera, one XXXL French fingertip resting against the glossy parted lips and the other hand at the waist, the face the focus of the frame showing the detailed bimbo makeup, a sensual half-lidded gaze, cherry red hair framing the face, the bodice and its detail crisp and legible",
 "waist-up shot framed from the waist up, the bust pushed forward and presented to the camera, one XXXL French fingertip twirling a lock of cherry red hair beside the face, the face the focus showing the detailed bimbo makeup and glossy parted lips, a sensual half-lidded gaze, the bodice and its detail crisp and legible",
 "waist-up shot framed from the waist up, the torso angled with the bust presented, one XXXL-nailed hand slowly slipping the shoulder strap off the shoulder while gazing at the camera, the face the focus showing the detailed makeup and glossy parted lips, a sensual half-lidded gaze, cherry red hair over one shoulder, the bodice detail crisp and legible",
 "waist-up shot framed from the waist up, the bust pushed forward and presented to the camera, XXXL French fingertips held just in front of the glossy lips blowing a kiss to the camera, the face the focus showing the detailed bimbo makeup, a sensual half-lidded gaze, cherry red hair framing the face, the bodice detail crisp and legible",
...
POV = [
 "intimate medium close-up addressing the camera with the energy of a sensual Instagram influencer, leaning toward the lens with the augmented bust pushed forward and dominant in the lower frame, one XXXL-nailed hand buried in the cherry red hair, a smoldering direct gaze and glossy parted lips, the face dominant in the upper-mid frame, a single woman alone",
 "sensual influencer self-portrait from a low angle looking up at the lens, the chin elevated and one XXXL-nailed hand trailing down the throat toward the cleavage, a half-lidded seductive gaze, lips parted glossy, the augmented bust dominant in the lower frame, cherry red hair falling forward, a single woman alone",
 "sensual Instagram-influencer candid, a three-quarter face glancing away from the lens with one XXXL-nailed hand pushing the cherry red hair back, lips parted glossy, an intimate seductive mood, the face in the upper-mid frame and deep cleavage below, a single woman alone",
 "sensual influencer self-portrait lying back and looking up into the camera from above, the augmented bust dominant in the frame, one XXXL-nailed hand resting on the collarbone, a sultry half-lidded gaze, lips parted glossy, cherry red hair fanned out, a single woman alone",
 "intimate sensual close-up addressing the camera, one XXXL French fingertip grazing and pulling the glossy bottom lip, a direct smoldering gaze to the lens, the face dominant in the frame and deep cleavage below, cherry red hair windblown, a single woman alone",
]
