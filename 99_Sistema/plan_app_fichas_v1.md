...
| **Checklist de materialización** | No existe. | #12 (parte de «La Flota») |
| **Buscador** | No existe. | #12 (parte de «La Flota») |

## 🆕 Fichas nuevas aprobadas (todas, 23/07)

| Ficha | Qué es | Datos que ya existen |
|---|---|---|
| 🏛️ **La Flota** | Pantalla de inicio / centro de mando: anillo de progreso, poses que faltan por look, últimos subidos + checklist + buscador. | Lee la galería que la app ya consume. |
...
| **#12 · Ficha «La Flota»** (+ checklist + buscador) | Centro de mando: qué falta materializar, sin que el tracker mienta. | Su dolor más repetido; independiente del audio. |
