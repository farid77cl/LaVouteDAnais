# CHANGELOG - La Voûte d'Anaïs

> *Historial de cambios importantes del repositorio.*
...
- ✨ `00_Helena/banco_prompts_v4.md` - 80+ prompts Fetish (marcas reales)
- ✨ `05_Imagenes/README.md` - Documentación de imágenes
- ✨ `05_Imagenes/galeria_master.md` - Galería unificada de personajes
- ✨ `.agent/workflows/generar_imagen.md` - Workflow de generación de imágenes
- ✨ `04_Historias/templates/` - Plantillas para historias
...
*Formato: [FECHA] Título - ✨ Añadido / 📝 Modificado / 🗑️ Eliminado / 📦 Movido*
🦇 Helena de Anaïs
