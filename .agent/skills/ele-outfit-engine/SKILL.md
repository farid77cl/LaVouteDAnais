...
5. **Ditzy — Waist-Up Sensual V4.1 SAFE (redef. Ama 10/06/2026):** `medium close shot framed from the waist up (waist-up — sensual detail of face and bust, NOT American/three-quarter knee-up shot), editorial fashion-model posture with soft lumbar arch, bust prominent and dominant in lower-mid frame, one XXXL French manicured fingertip resting gently against chin or bottom lip (single hand clearly visible — the other arm rests along body with hand at waist), soft daydreaming expression with eyes slightly unfocused half-lidded and lips softly parted glossy, dramatic lash extensions, cherry red hair cascading over one shoulder framing breast, torso outfit legible in frame, shoulders dropped extending collarbone, [fondo blur], 8k editorial fashion photography` — **redef. 10/06:** el encuadre pasó de plano americano (knee-up) a **waist-up** (detalle sensual rostro + busto). Single hand visible (la otra at waist) para evitar artefactos multi-mano. **NEGATIVE PROMPT ADICIONAL:** `extra hands, multiple hands, three hands, four hands, duplicate hands, six fingers, extra fingers, malformed hand, deformed hand`.

6. **POV — Autorretrato sin teléfono V4.1 SAFE (redef. Ama 10/06/2026):** `influencer-style self-portrait of a single woman alone, first-person POV looking down over her own body from slightly above, chest and XXXL French nails prominent in sharp foreground, full outfit visible converging down toward pointed stiletto tips in lower frame, NO phone NO camera NO device in hand, confident direct downward gaze, pouty glossy lips parted softly, cherry red hair falling forward framing the shot, [fondo shallow blur], 8k social media fashion photography` — **redef. 10/06:** SIN teléfono/cámara en mano (antes "holding smartphone"); es autorretrato de **una sola mujer sola** mirándose el propio cuerpo (influencer sexual IG). ⚠️ **NEGATIVE PROMPT ADICIONAL:** `no phone, no smartphone, no device, no screen, no camera in hand, extra hands, multiple hands, three hands, four hands, duplicate hands, six fingers, extra fingers, malformed hand, deformed hand, two left hands, two right hands`.
...
| **Ditzy** | **frontal eye-level** | **WAIST-UP (cintura arriba)** | **rostro + busto sensual + finger-on-lip** |
| **POV** | **autorretrato cenital** | **single woman alone, SIN teléfono** | **chest + XXXL nails foreground → stiletto tips** |
