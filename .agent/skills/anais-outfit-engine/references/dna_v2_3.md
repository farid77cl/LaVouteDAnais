...
| Cuerpo | `slender and lean, naturally fit firm physique, not voluptuous, not augmented, not bimbo-exaggerated, natural moderate firm breasts, firm smooth glutes softly toned rather than sharply muscular` — válido con o sin corsé; el corsé agrega la curva de cintura dramática, no cambia el resto |
...
| Labios | `vivid deep crimson classic Hollywood red lips` |
