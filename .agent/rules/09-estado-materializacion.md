...
|-----------|-------|--------|
| **Flota Diseñada (último look)** | **L680** | 🟢 ~550 únicos |
...
| **Último batch** | **L671-L680 "Barroco Fetish"** (10 looks · 70 prompts · TODOS corset + pelo EN ALTO (updo) + lente fetish · Gala/Lencería×2/Escort/Nightclub/Corporate/HF/Pin-Up/Stripper/Bikini · poses **rotadas de verdad** · QA: 0 guantes/chunky/POV-literal, corset ×10, tokens calzado ×7, ancla por slot) · inyector corregido `_gen_batch_671.py` | 🔮 Registrado (prompts) |
...
| **Batch anterior** | **L661-L670 "Cuero Negro Total"** (10 looks · 70 prompts · TODOS cuero/vinyl/latex negro · QA: 0 guantes/chunky/open-toe/clear-platform, tokens calzado ×7) | 🔮 Registrado (prompts) |
