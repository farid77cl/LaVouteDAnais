...
## 🖥️ FIDELIDAD PROMPT→IMAGEN (Directiva Ama 11/07/2026 — auditorías L691-L760 y L729-L760/Seated)

Cinco desvíos sistemáticos detectados mirando la imagen final vs el prompt. Todos blindados en el motor (`pose_rotation_v5.py` + `garment_canon.py`); el inyector DEBE aplicarlos:
