...
Se mide, no se promete: `python 99_Sistema/scripts/mantenimiento/lint_higiene_repo.py` — meta **0**, y corre en el paso 0bis de `/inicio-ele` **y** el 6.6 de `/actualizar_sesion` (abrir y cerrar). Regla completa: [`12-higiene-documental.md`](12-higiene-documental.md).
