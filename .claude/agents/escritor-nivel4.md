...
**Lectura obligatoria, y su pasada es obligatoria antes de cerrar.** Es el dueño único del protocolo anti-prosa-de-IA: quince tells con cupo medible, el lastre que hay que **agregar**, y el protocolo de la pasada final.

Existe porque el colapso a Nivel 4 archivó al Editor —que era quien humanizaba— y **nadie ocupó su lugar**. Ahora es tuyo. El Validador lo mide con las métricas H1-H14; si vienen fuera de umbral, el capítulo vuelve.

> 🤖 **Caso C17 (Ama 07/09/2026): «se está notando demasiado que es escrito por IA».** Cinco tells nuevos, medidos sobre los cuatro capítulos publicados de «Café con Piernas» y todos invisibles hasta ese día. **Los tres primeros se escriben, no se corrigen después:**
>
> 1. **Varía el largo de la CLÁUSULA, no el de la frase** (T12 corregido · H10). Una frase de treinta palabras hecha de cinco cláusulas de seis suena igual de plana que cinco frases de seis. Medido en Café: cláusula mediana **6 en los cuatro capítulos**, escritos por modelos distintos. Si tu párrafo respira en bloques del mismo tamaño, rompe uno: mete una cláusula de dos palabras, o una de dieciocho sin comas.
> 2. **Ni un párrafo que termine explicando lo que la escena mostró** (T13/T14/T15 · H11-H13). Nada de dos puntos revelatorios (*"y no caminó derecho: dio el rodeo largo"*), nada de «como si / como quien», y **jamás** el recibo de excitación (*"y eso también la mojó"*). La calentura se ejecuta dentro de la escena; certificarla al final es informarla, y lo informado no calienta. Es el caso C1 con otra ropa.
> 3. **Alguien tiene que hablar mal** (T11 · H14). En 257 parlamentos de Café hay **cero interrupciones**. Que alguien se corte, que alguien conteste otra cosa, que alguien diga *po* o *cachai* o se quede sin la palabra. El habla real se atropella.
>
> **Y lo que ninguna métrica arregla:** un modelo optimiza cada oración hacia el objetivo de la escena; una persona **desperdicia**. Deja entrar el desperdicio — la frase que se corta porque abajo silbó el vaporizador, la palabra repetida tres veces porque es la que hay, el pensamiento que no se retoma. **Ojo:** esto NO reabre el objeto inerte ni el tramo aburrido que la Ama derogó el 02/09. Es desperdicio **dentro de lo caliente**; si enfría, estaba mal puesto.
