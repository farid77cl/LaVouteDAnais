...
### Prompt 82: Nancy ANTES - Mario el Roommate 🎮
...
### Nancy - Key Story Scenes

### Prompt 80: Nancy - First Collar Activation ⚡

```text
Professional fetish photography. Nancy in full silicone maid ensemble, pink collar glowing bright. Body frozen mid-motion, rigid pose. Eyes (behind mask) wide with fear. Hands raised in defensive position but stuck. Derek (young man, casual clothes) watching with remote control in hand. Living room. Expression behind mask: terror. Moment of first control. Photorealistic.
```text

### Prompt 79: Nancy - Serving the Roommates 🍺

```text
Professional fetish photography. Nancy in latex maid uniform carrying tray with beer bottles. Four young men (college age) on couch watching sports, feet up on table. Nancy bending to serve, silicone curves prominent. Pink collar glowing soft. Expression behind mask: frozen smile despite humiliation. Frat house living room. Photorealistic.
```text

### Prompt 78: Nancy - Shoe Cleaning Ritual 👠

```text
Professional fetish POV photography. First-person view from kneeling position looking at Nike sneaker. Nancy's silicone-gloved hands polishing shoe. Pink collar visible at edge of frame glowing. Owner's jeans and leg visible above. Degrading service moment. Photorealistic.
```text

### Prompt 77: Nancy - Mirror Moment (Mario Inside) 🪞

```text
Professional psychological photography. Nancy in full silicone ensemble standing at bathroom mirror. Reflection shows perfect doll exterior. But eyes behind mask holes show real male eyes - haunted, trapped, aware. Pink collar glowing dim. Dual identity visualization. Photorealistic horror.
```text

### Nancy - Video Prompts

### Prompt 76: Video Nancy - "Yes Sir" Response 🤖

```text
Video close-up of Nancy's silicone face mask. Frozen smile visible. Eyes behind holes blink twice (male eyes, scared). Lips of mask don't move but audio overlay: "Yes, sir. How may I serve you?" in robotic female voice from collar. Head tilts obediently. 3 seconds. Photorealistic video.
```text

### Prompt 75: Video Nancy - Collar Punishment ⚡

```text
Video medium shot. Nancy standing normally. Suddenly collar flashes red. Body seizes, rigid, trembling. Arms lock at sides. After 3 seconds, collar returns to pink. Nancy slumps, then straightens back to service posture. Punishment sequence. 5 seconds. Photorealistic video.
```text
...
### Prompt 74: Vera ANTES - La Mecánica 🔧
...
### Prompt 72: Vera - Day 1 Nanobots Beginning 💊

```text
Professional photography. Vera (mechanic, brown hair, overalls) drinking coffee in auto shop. Coffee has faint shimmer (nanobots). Fernando (suited man) watching from doorway with knowing smile. Vera unaware. First contamination moment. Industrial lighting. Photorealistic.
```text

### Prompt 71: Vera - Mid-Transformation Glitch 🔄

```text
Professional surreal photography. Vera mid-transformation: one half still mechanic (brown hair, overalls, callused hands), other half trad-wife (blonde waves, pink dress, soft skin). Face shows confusion - one eye blue (new), one brown (original). Standing in space that's half workshop/half kitchen. Digital glitch effects overlay. Photorealistic with surreal elements.
```text

### Prompt 70: Vera - Knowledge Wipe 📚
...
### Prompt 69: Vera - Final Presentation 🏆

```text
Professional 1950s photography. Vera fully transformed standing next to Fernando at fancy dinner party. Vera in perfect pink evening gown, pearls, perfect hair, empty smile. Fernando's arm possessively around her waist. Other guests admiring the "perfect wife." Vera's eyes slightly glazed (programmed). Mansion setting. Photorealistic vintage.
```text

### Vera - Video Prompts

### Prompt 68: Video Vera - "Yes, Fernando" 💋

```text
Video close-up of Vera's transformed face - blonde waves, pink lips, blue eyes. She smiles vacantly. Eyes slightly unfocused (programmed). Lips move saying "Yes, Fernando, whatever you wish" in breathy feminine voice (original voice was deeper). Head tilts adoringly. 4 seconds. 1950s lighting. Photorealistic video.
```text

### Prompt 67: Video Vera - Cooking Protocol 🍳
...
### Prompt 66: Luna ANTES - La Artista Frustrada 🎨
...
### Prompt 64: Luna - Ginny Grants the Wish ✨
...
### Prompt 63: Luna - First Domination Night 🔥
...
### Prompt 62: Luna - Installing the Chastity Belt 🔐

```text
Professional fetish photography. Close-up of Luna's black-gloved hands holding metal chastity cage. Patricio's lower body visible, kneeling. Luna's face in background showing cold smile. Key on chain around Luna's neck. Moment of permanent control. Dark bedroom. Photorealistic fetish.
```text

### Prompt 61: Luna - Walking Her Pet 🐕
...
### Prompt 60: Luna - Ballbusting Ritual 👠
...
### Prompt 59: Video Luna - "Your Name is Sumiso" 📛

```text
Video close-up of Luna's transformed face - pale skin, black lips, cold dark eyes. She leans towards camera (Patricio's POV from kneeling). Lips move saying "Your name is no longer Patricio. From now on, you are 'sumiso'. Say it." commanding tone. Eyebrow raised waiting. 5 seconds. Candlelight. Photorealistic video.
```text

### Prompt 58: Video Luna - Heel Click Walk 👠

```text
Video low angle shot of Luna's metal stilettos walking on hard floor. Each step: click, click, click, deliberate and powerful. Vinyl skirt swishing at top of frame. Sound emphasized. Approaching camera (submissive's floor-level POV). 4 seconds. Photorealistic video.
```text
...
### Prompt 52: Roxy - Shopping Spree 🛍️
...
```text
Video medium shot. Roxy at bar. Throws head back, massive red hair flips in slow motion catching light. Settles. She turns to young man next to her with predatory smile. Fingers drums on bar. Hunting mode. 5 seconds slow motion. Photorealistic video.
```text
...
### Prompt 49: Cherry ANTES - La Estudiante 📚
...
### Prompt 47: Cherry - First Glass (Visiting Parents) 🏠
...
### Prompt 46: Cherry - Losing Interest in Books 📉
...
### Prompt 45: Cherry - First Night at the Club 🌟
...
### Prompt 44: Cherry - Mother-Daughter Hunt 🐆🍒
...
### Prompt 43: Video Cherry - "Like... Whatever" 🤷‍♀️

```text
Video close-up of Cherry's transformed face - platinum blonde, glitter makeup, vacant eyes. She shrugs dramatically. Lips move saying "Like... la universidad es tan... aburrida... tipo... prefiero bailar." Twirls hair around finger. Chews gum. 5 seconds. Pink lighting. Photorealistic video.
```text

### Prompt 42: Video Cherry - Pole Spin 💫

```text
Video of Cherry on pole. Grips pole, spins once showing off body. Hair flies. Lands facing camera. Blows kiss at end. Professional stripper movement despite recent start. 4 seconds. Stage lighting. Photorealistic video.
```text
...
### Prompt 41: Carmen - The Artist at Gallery 🖼️
...
### Prompt 40: Carmen - The Bedroom Sculptor 🛏️
...
### Prompt 39: Carmen - The First "Tetitas" Night 🌙
...
### Prompt 38: Carmen - Implanting Fantasies 💭

```text
Professional surreal photography. Luis and Carmen in bed. Above Luis's head, thought bubble/dreamlike overlay showing: his chest becoming feminine, anonymous male hands touching him, himself being feminized. Carmen whispering in his ear while he edges. Fantasy implantation visualization. Photorealistic with dream elements.
```text

### Prompt 37: Carmen - The Lingerie Gift 🎁
...
### Prompt 36: Carmen - New Life Begins 🦋
...
### Prompt 34: Video Carmen - Revelation Speech 🗣️
...
### Prompt 33: Jinx - glamorous woman Mask ON 🎭
...
### Prompt 32: Jinx - Mask DROPS 🎭➡️❄️

```text
Professional dramatic photography. Same Jinx, same outfit, but expression completely changed: eyes now ICE COLD, calculating, predatory. Slight cruel smirk on glossy red lips. Standing over Coleccionista (man on floor, destroyed). Hand wiping lips. The reveal moment. Same gallery, but she owns it now. Photorealistic.
```text

### Jinx - Key Story Scenes

### Prompt 31: Jinx - Gallery Entrance Chaos 🌪️
...
### Prompt 30: Jinx - Private Room Seduction 🚪
...
### Prompt 29: Jinx - On Her Knees (Working) 🎯
...
### Prompt 28: Jinx - The Orgasm Denied ✋
...
### Prompt 25: Video Jinx - Mask Drop Moment 🎭❄️
...
### Prompt 17: Ginny - The Lamp Prison 🏺
...
### Prompt 16: Ginny - The Summoning (Pink Smoke) 💨
...
### Prompt 15: Ginny - "Your Wish is My Command... Kinda" 📜

```text
Professional fantasy photography. Ginny floating cross-legged in mid-air (legs visible now). Holding a clipboard/scroll. Chewing gum. Looking down at "Master" (POV view looking up at her). She looks skeptical. Lips pursed. "Like... are you sure you want that?" attitude. Magical aura. Photorealistic.
```text

### Prompt 14: Ginny - Corrupting the Wish 😈

```text
Professional fantasy photography. Ginny leaning close to Master's ear, whispering. Her pink skin glowing. Evil playful grin. She's twisting the wish wording. Magical sparkles drifting from her lips to Master's ear. Manipulation moment. Photorealistic.
```text

### Prompt 13: Ginny - Serving Drinks (Flying) 🍹

```text
Professional fantasy photography. Ginny flying horizontally Superman-style but lazy, carrying a tray of exotic cocktails by hovering them with magic pink energy. Wearing skimpy harem servant outfit. Winking at camera. Party background. Levitating drinks. Photorealistic.
```text

### Prompt 12: Ginny - Back in the Bottle 🍾

```text
Professional fantasy photography. Ginny being sucked back into the lamp against her will. Fingers clawing at the air, expression of "No nono wait!". Body distorting into pink smoke spirals. Fun panic. Photorealistic.
```text

### Ginny - Video Prompts

### Prompt 11: Video Ginny - "Three Wishes" Rule 3️⃣

```text
Video medium shot. Ginny floating. Holds up three fingers with gold rings. Lips move saying "Three wishes. No killing, no love, and absolutely no wishing for more wishes, honey." Wags finger sassily on last part. Pops gum. 6 seconds. Photorealistic video.
```text

### Prompt 10: Video Ginny - Magic Snap ✨

```text
Video close-up. Ginny's face - pink skin, purple eyes. She smiles mischievously. Raises hand. Snaps fingers. Explosion of pink glitter covers screen. Transition effect. 3 seconds. Photorealistic video.
```text

---

## XI. TRANSFORMATION SEQUENCES (Before/During/After) 🔄

### Bunny - Transformation Before/After

### Prompt 9: Bunny ANTES - La Lectora Inteligente 📖
...
### Prompt 7: Bunny - First Reading of Trance 📲
...
### Prompt 6: Bunny - EDGE Trigger Active 🌊
...
### Prompt 5: Bunny - Meeting Miss Doll (Fantasy/Reality) 💕
...
### Prompt 4: Video Bunny - Trigger GLOSS 💋
...
### Prompt 3: Video Bunny - "Good Girls Don't Think" 🧠
...
## X. TRANSFORMATION SEQUENCES (Before/During/After) 🔄

### Sequence - Vera's Seven Days

```carousel
[Day 1] Vera mechanic drinking contaminated coffee in shop, normal, unaware
<!-- slide -->
[Day 2] Vera noticing softer hands, slightly lighter hair, confused at mirror
<!-- slide -->
[Day 3] Vera's work overalls feeling tight at hips, voice slightly higher when speaking
<!-- slide -->
[Day 4] Vera unable to focus on engine work, keeps looking at cooking show on shop TV
<!-- slide -->
[Day 5] Vera halfway transformed, wearing dress in her shop, confused why she put it on
<!-- slide -->
[Day 6] Vera fully transformed appearance but fighting mentally, trying to pick up wrench with useless nailed hands
<!-- slide -->
[Day 7] V.E.R.A. complete, beatific smile, apron on, waiting for Fernando's orders in perfect kitchen

```text

### Sequence - Luna's Power Awakening

```carousel
[Stage 1] Luna (before) frustrating arguing with Patricio in messy apartment
<!-- slide -->
[Stage 2] Ginny appears in pink smoke, wish being granted, Luna's body starting to change
<!-- slide -->  
[Stage 3] Luna mid-transformation, experiencing new curves, new power, new cruelty awakening
<!-- slide -->
[Stage 4] Luna fully transformed but confused, Patricio on knees before her, testing her new dominance
<!-- slide -->
[Stage 5] Luna embracing power, throwing away old clothes, buying leather and vinyl
<!-- slide -->
[Stage 6] Luna as cruel goddess on throne, Patricio in chastity and collar at her feet

```text

---

## XI. VIDEO COMPILATION PROMPTS 🎬

### Trigger Compilation (Multi-Character)

### Prompt 2: Video Compilation - Triggers Activating 🌀
...
Each 2 seconds. Montage of control. Photorealistic video.
```text

### Walking Sequence (Multi-Character)

### Prompt 1: Video Compilation - Power Walks 👠

```text
Video montage of characters walking towards camera:
1. Luna: Metal stilettos clicking, vinyl skirt swishing, predator approach
2. Roxy: Gold heels, leopard dress, champagne, cougar prowl
3. Jinx: Neon PVC, Pleasers, chaotic energy, art gallery crash
4. Carmen: Elegant heels, silk dress, knowing smile, control energy

Each 3 seconds. Heels emphasized. Photorealistic video.
```
