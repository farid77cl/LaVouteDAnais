...
- El cuerpo "traicionando" a la mente
...
"Cada respiración que tomo los hace subir y bajar lentamente. 
Hipnóticamente. Como si respiraran para ti."
— Trance Bimbodoll
```
...
- La voz interna cambiando de tono
...
4. Aceptación gradual ("Quizás no es tan malo...")
5. Rendición total ("Soy tuya")
...
- La víctima balbucea, gime, susurra
...
- El narrador a veces "sabe más" que el personaje

---

## II. PATRONES PROBLEMÁTICOS A EVITAR

| Problema | Descripción |
|----------|-------------|
| **Resumen excesivo** | "Pasaron tres semanas de transformación" - NO |
| **Transiciones rápidas** | Saltar de escena A a escena C sin B |
| **Víctima pasiva** | Debe haber lucha, aunque pierda |
| **Falta de detalles físicos** | Cada cambio corporal merece descripción |
| **Setup sin desarrollo** | Introducir elementos y no desarrollarlos |
| **Capítulos cortos** | Menos de 2,000 palabras se siente incompleto |
...
- Finales abiertos sin resolución emocional
- Descripciones genéricas ("se sintió bien")
...
```
[Párrafo normal - despertar]
---
[Corte abrupto - ya es otro momento]
[Descubre cambio físico]
[Intenta recordar - falla]
---
[Otro corte - más tiempo ha pasado]
[Más cambios - menos resistencia]
```

**Efecto deseado:** El lector debe sentir claustrofobia, no entender exactamente cuánto tiempo ha pasado, y experimentar el horror de notar cambios en su propio cuerpo sin contexto.
