# Arco Argumental — La Deuda

> **Título:** La Deuda / Cuotas de Feminidad
> **Tema:** Transformación por deuda usurera — cada cuota impaga = más feminización
> **Fecha:** 2025-12-29
...
| **Edad post-transformación** | ~25 años (rejuvenecido) |
| **Ocupación** | Emprendedor serial fracasado (100+ negocios fallidos) |
| **Defectos fatales** | Soberbia, megalomanía, ignorancia — siempre el "negocio del siglo" sin capacidades reales |
| **Negocios fallidos** | Restaurantes, apps, cripto, importaciones, franquicias, MLM, bienes raíces... |
| **Estado inicial** | A punto de desahucio, múltiples acreedores, sin dinero, desesperado |

### Victoria (Acreedora/Ex-novia/Mafiosa)
...
| **Poder actual** | Prestamista, trata, drogas — TODO |
| **Aura** | Mística, dura, impenetrable |
| **Motivación** | Venganza + amor retorcido |
| **Enforcers** | Matones grandes y musculosos |
...
| **Monto** | $5,000,000 USD |
| **Cuotas** | 50 cuotas |
| **Interés** | 30% mensual (usurero, imposible) |
| **Diseño** | INFINITA — imposible de pagar por diseño |
| **Letra pequeña** | SÍ — trampas ocultas que él no lee (como siempre) |
| **Penalización por mora** | Cada cuota impaga = transformación forzada |
...
## TABLA DE CUOTAS (Resumida)

| Cuotas | Transformación |
|--------|----------------|
| 1-5 | Depilación, ropa interior, maquillaje básico |
| 6-10 | Hormonas, voz, gestos femeninos |
| 11-20 | Implantes pecho, labios, rostro |
| 21-30 | Nombre legal, trabajo femenino humillante |
| 31-40 | Vestimenta 24/7, comportamiento bimbo |
| 41-50 | Cirugía genital, propiedad total |

---

## CONEXIÓN CON LA VOÛTE

- Victoria ascendió porque se conectó con el mundo de Anaïs
- Su poder místico viene de rituales de La Voûte
- Posible aparición de Miss Doll como "asesora" de Victoria
- El contrato tiene magia de La Voûte: es literalmente irrompible

---

*Arco creado: 2025-12-29*
*Siguiente paso: FASE 3 - Escritura de capítulos*
