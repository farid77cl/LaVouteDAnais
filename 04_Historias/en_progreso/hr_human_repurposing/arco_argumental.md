...
flowchart LR
    ...
    subgraph "ACTO II"
        A --> B["👗 Cap 2<br/>El Proceso"]
        B --> C["🌸 Cap 3<br/>Dahlia"]
    end
    
    subgraph "ACTO III"
        C --> D["🔄 Cap 4<br/>El Ciclo"]
    end
...
```mermaid
timeline
    title La Caída de Daniel Park
    
    Cap 1 : 📋 LA MARCA
          : Marcado para PIP
          : Pierde estatus de "persona"
    
    Cap 2 : 👗 EL PROCESO
          : Transformación sin consentimiento
          : Aislamiento del exterior
    
    Cap 3 : 🌸 DAHLIA
          : Muerte de identidad
          : Sirve a ex-subordinado
    
    Cap 4 : 🔄 EL CICLO
          : Se convierte en herramienta
          : Transmite el sistema
```
