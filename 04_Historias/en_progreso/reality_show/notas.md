...
### Opción A: Muñeca de Porcelana (Porcelain Skin)

- **Físico:** Depilación total permanente. Piel de polímero biológico: blanca, fría, perfecta.

- **Sensorial (Erotizado):** Hipersensibilidad táctil conectada directamente al centro de placer.
  - *Roce General:* La ropa áspera excita levemente por fricción constante.
  - *Zonas Calientes (Hotspots):* Pezones, pubis, y labios reaccionan con descargas de placer intenso al menor contacto.
  - *Zonas Bimbo Extra:* **Cuello** (vulnerabilidad/sumisión), **Interior de muslos** (acceso sexual) y **Arco del pie** (preparación para tacones).
- **Psicológico:** "Desnudez" perpetua. Marco se siente expuesto, como si estuviera siendo acariciado constantemente por el aire y la ropa.

### Opción B: Boca de Muñeca (Doll Mouth)

- **Físico:** Labios inyectados al máximo. Imposible cerrar la boca (siempre entreabierta/húmeda).

- **Sensorial (Placentero):** Nada de dolor. Los labios vibran con un placer bajo y constante, "pidiendo" ser usados. La boca se siente vacía y necesitada.
- **Funcional:** Dificultad fonética. Babeo leve incontrolable que se siente delicioso.
- **Efecto:** La necesidad de chupar o lamer se vuelve un instinto biológico para aliviar el "picor" de placer en los labios.

## 📝 Banco de Preguntas - Bloque 2 (Bimbo Trivia)

*Tema: Conocimiento de Stripper / Escort / Cirugía Plástica.*
*Objetivo: Humillar el intelecto de Julián y premiar la "calle" de Marco.*
