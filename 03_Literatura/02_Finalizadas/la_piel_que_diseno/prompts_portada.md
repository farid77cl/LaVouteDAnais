...
> 🗑️ **Los prompts de imagen anteriores se eliminaron.** Eran de dos generaciones —los
> originales y la tanda «v2 Wattpad Ready» del 22/07— y **las dos eran fotorrealistas con el
> título quemado dentro de la imagen** (`TYPOGRAPHY (rendered in image)`). El **07/09** la Ama
> congeló el [estilo cómic pop](../../../01_Canon/Guias_Especializadas/estilo_comic_pop_v1.md)
> como dueño único del look de las publicaciones, con **cero texto adentro**.

> ✅ **Cada prompt está COMPLETO.** Se copia el bloque entero de una vez y se pega.
> 📐 Todos en **4:5 vertical**. 🚫 Sin bloque negativo y sin pesos `:1.4`.

### 📁 Cómo se llama cada archivo y dónde va

| # | Post | Archivo |
|---|---|---|
| 1 | Post fijado del relato | `05_Imagenes/historias/la_piel_que_diseno/portada_la_piel_que_diseno.jpg` |
| 2 | Gancho Cap 1 | `05_Imagenes/historias/la_piel_que_diseno/imagen1_despertar.jpg` |
| 3 | Gancho Cap 2 | `05_Imagenes/historias/la_piel_que_diseno/imagen2_postre.jpg` |
| 4 | Gancho Cap 3 | `05_Imagenes/historias/la_piel_que_diseno/imagen3_camarin.jpg` |
| 5 | Gancho Cap 4 | `05_Imagenes/historias/la_piel_que_diseno/imagen4_bailarina.jpg` |

**JPG, 4:5 vertical.** Las cinco viven juntas en `05_Imagenes/historias/la_piel_que_diseno/`.

> 🗑️ **No se quedan en el disco.** Una vez aprobadas se commitean y se sacan de este clon.
