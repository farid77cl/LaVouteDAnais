...
Fernanda, secretaria **humillada a diario** durante tres años —el ninguneo de Cristóbal no es un evento: es rutina visible, chica y constante, y el relato lo MUESTRA hasta que la venganza queda justificada—, recibe **a primera hora de un lunes** un WhatsApp de un número desconocido que sabe su apellido: un mensaje de Miss Doll y el enlace de una app. **Esa misma mañana, antes de la reunión**, a su jefe —Cristóbal Undurraga, gerente comercial matón de una corredora en El Golf— lo espera en el escritorio un **reloj de lujo, cargado de tecnología, sin remitente**, con una tarjeta-acertijo firmada **"MD ❤"**. Él se lo abrocha solo, por pura vanidad, y **entra a la reunión de las 8:30 estrenándolo**. Fernanda instala la app **ahí mismo, en la oficina**, y prueba **mientras él preside**: cada cambio que toca en la pantalla ocurre **al instante**, a metros de ella, al otro lado del vidrio — en el minuto exacto en que él la está usando de insulto delante de doce personas. Recién cuando constata ese poder inmediato **empieza la venganza** —que por eso nace **DENTRO** del agravio y no a continuación de él (inversión ordenada por la Ama el 20/07; el motivo sigue siendo de AÑOS: la reunión es la gota, no el origen)—: afina el control gota a gota y le inyecta una personalidad que ella misma diseñó: **Kitty**. Cristóbal **nunca sabe lo que pasa hasta que es tarde** — pero **se da cuenta de lo que hace** y pelea cada gesto. Venganza fría que se convierte en gusto por la propiedad; final sin rescate: él odiándolo todo, revisando la hora de su turno de mañana.
...
- **Por qué excita:** El cuerpo delata lo que la mente niega: la caminada, el gesto, el deseo ajeno instalándose en carne propia. La ruina es pública (la reunión) e íntima (la cama) en el mismo capítulo.
- **Error fatal:** Que la escena con Antonia funcione o termine en ternura. Que el deseo anal sea "de Cristóbal" — es de Kitty; él lo padece. Rescate de Antonia.
- **Ubicación temporal:** Cap 2, Días 9–21.

### Pivote 4 — Nace Kitty completa: el debut y el directorio
- **Qué ocurre:** Despacho final del catálogo: breast plate y máscara de sonrisa congelada. Ceremonia completa. El gerente se borra con una mentira administrativa; Kitty debuta como recepcionista de *Living Doll Experience*. Primer servicio oral (la arcada premiada). Y la junta de directorio completa: el préstamo, **el orgasmo no pedido**.
- **Por qué excita:** Despersonalización total con normalidad de trámite; el cuerpo lo traiciona delante del poder que él quería impresionar; el condicionamiento cobra el premio máximo sin permiso de la mente.
- **Error fatal:** Rescate, interrupción, o que el orgasmo sea "permitido". Es NO pedido. Este es el PICO máximo del relato. Que alguien trate la máscara como disfraz: la oficina ACEPTA a Kitty.
- **Ubicación temporal:** Cap 3, Días 22–25.

### Pivote 5 — La propiedad
- **Qué ocurre:** Fernanda constata que la venganza ya se pagó... y no lo devuelve. Cristóbal solo en el estacionamiento, vacío químico, el reloj quieto en la muñeca, revisando la hora de su turno de mañana. Al chat de Fernanda llega el **mensaje #2 de Miss Doll** (rima con el primero) + el catálogo de renovación anual.
...
### Fernanda (SIN apellido — marca narrativa **[LITERAL AMA]**: nadie se lo preguntó nunca; solo Miss Doll lo sabe)
- **Rol narrativo:** Controladora metódica **y aprendiz**: los primeros comandos son torpes, casi tímidos; la maestría llega con el gusto. Venganza fría que se convierte en gusto por la propiedad; administra el poder (app, planilla, protocolo), no lo goza a gritos.
- **Autoría [LITERAL AMA 17/07: "la personalidad de kitty es idea de fernanda"]:** Kitty no viene de fábrica — **Fernanda la diseña** en el editor de la app: el nombre, el registro porno mal doblado, lo ridículamente bimbo. La venganza tiene autora; cada brote de Kitty es obra suya.
- **Frase tipo [canónica — Gate 16/07]:** *"A las 7:30 te quiero depilado y con el uniforme puesto. Y no me hagas repetirlo, que tengo tu agenda hasta el 2028."*
...
- **Rol narrativo:** Tienta, no instruye; el deseo ya estaba ahí. Presente SOLO en la tarjeta del reloj ("MD ❤"), en los dos mensajes de WhatsApp a Fernanda, y en la app. Nunca aparece en persona.
- **Invariante:** Siempre sabe más de lo que dice. Sabe el apellido de Fernanda; el relato jamás lo revela al lector. Al juguete le firma "MD ❤"; a la clienta, Miss Doll.

**Figurantes:** **Antonia** (novia de Cristóbal) — ahora con UNA escena propia: el intento de sexo del Cap 2. Funcional, peso acotado; queda avergonzada/espantada y se va, no vuelve. El resto de la oficina y el directorio: sin nombre o nombre de pasada.
...
1. El reloj en su caja negra sin remitente, sobre el escritorio del gerente, con la tarjeta "MD ❤".
2. La burbuja de WhatsApp de número desconocido que sabe su apellido, y el pulgar de Fernanda dudando sobre el enlace.
3. La pantalla del editor de la app: los deslizadores de la persona "Kitty" al máximo, y las uñas cortas sin esmalte de Fernanda ajustándolos.
4. La máscara sobre el escritorio del gerente, sonriendo hacia el sillón vacío, antes de instalarse.
5. El catálogo de renovación anual llegando al mismo chat, bajo el mensaje #2.

## 6. Mapa de Capítulos (4 — arco fusionado por la Ama)

| Cap | Pivote(s) | Mecanismo dominante | T° (abre → cierra) | Cierre del cap |
|-----|-----------|---------------------|--------------------|----------------|
| 1 | P1, P2 | Vanidad como correa; controles torpes; la voz que se instala | Fuego frío → media | Reunión del lunes (Día 8): la primera frase de Kitty se le sale por la boca — vergüenza sin explicación; Fernanda guarda el celular |
| 2 | P3 | Ruina progresiva; el cuerpo delata (marcha, coño, deseo anal) | Media → alta | Antonia se fue; a oscuras, las caderas puestas, el deseo de Kitty latiendo donde él no quiere sentirlo |
| 3 | P4 | Despersonalización; el cuerpo traiciona delante del poder | Alta → PICO MÁXIMO | Orgasmo no pedido frente a la junta completa |
| 4 | P5 | Propiedad sin fecha de término; vacío químico | Rescoldo del pico → brasa final | Estacionamiento; revisa la hora del turno; el mensaje #2 en el chat de Fernanda |
...
- **Prohibido que Cristóbal entienda a tiempo.** Nada de deducciones tempranas, sospechas certeras ni desarme del mecanismo: la comprensión llega siempre después de la pérdida.
- **Prohibida la posesión de golpe.** Kitty se inyecta por goteo; el OS jamás "toma el cuerpo" entero antes del Cap 3. El clic fundacional está DEROGADO.
- **Prohibido que Kitty tenga un segundo registro.** Ni natural, ni chilena, ni elegante, ni dubitativa: solo el porno peninsular mal doblado, siempre. Y jamás vestirla sobria: plataforma + micro falda + extra escote + medias en TODA aparición.
- **Prohibido el infodump de la app o el reloj.** Se muestran en acción (la pantalla de Fernanda, los deslizadores, los pulsos, los brotes), nunca en manual. La tecnología no se explica.
...
- **Kitty [registro único porno mal doblado]:** *"Living Doll Experience, muy buenos días. ¿En qué puedo atenderle?"* · *"Enseguida, señor. Ha sido un placer atenderle."* · *"Así, muy bien, señor... ¿le gusta cómo se la chupo?"*
- **Mensaje #2 de Miss Doll (WhatsApp, cierre) [texto aprobado Gate 16/07; medio ahora digital]:** *"Sabía que no lo devolverías, Fernanda. Nadie devuelve lo que le pertenece. Adjunto el catálogo de renovación anual de accesorios — las clientas preferentes tienen despacho prioritario. — Miss Doll"*

## 10. Mecánica de despachos [PROPUESTA COMPOSITOR — pendiente Gate]

La caja del Día 1 trae SOLO el reloj. Las piezas de silicona llegan después, **por despachos del catálogo de la app**: Fernanda pide, Miss Doll despacha (hip pads + panel en el Cap 2; breast plate + máscara en el Cap 3). Cada paquete es un hito — y el catálogo rima con la "renovación anual" del cierre.
