# Canon Relato — La Secretaria de su Esposa

> **v4.7 (Nivel 4) — Un solo documento. Voz literal de la Ama gana sobre cualquier interpretación.**
>
> **Fecha:** 2026-05-27 (refundación post v0.1 v4 — la Ama declaró la premisa del contrato laboral inválida)
> **Reemplaza:** arco_maestro_v1.md + personajes_maestro_v1.md + mapa_erotico_v1.md + mapa_erotico_cap1_v1.md + concepto.md + linea_de_tiempo_maestra.md + CONCEPTO_AMA_LITERAL.md + ritual_calenton_cap1_pre.md + mecanismo_calenton_cap1.md (todos archivados en `borradores/_canon_v45_pre_nivel4/`)
> **Total palabras objetivo:** ~2,000 (no por capítulo — por TODO el relato)

---

## 1. Premisa (voz literal de la Ama, 27/05/2026)

> *"Valeria es dueña de casa/influencer de moda y maquillaje. Esteban está desempleado hace mucho tiempo, con deudas. Valeria monta un engaño usando que Gabriel — al que Esteban conoce solo de nombre — es su amante. Le presenta a 'Estefanía' como amiga necesitada de trabajo. Engaño triple: al trabajo donde Estefanía será secretaria (creen que es mujer), a Gabriel mismo (no sabe que su nueva secretaria es el marido de su amante), y al círculo social. En el camino, Valeria empieza a disfrutar ver el cambio en Esteban. Gabriel se entera tarde — cuando ya es muy tarde — de quién es Estefanía."*

**Lectura crítica:**
- **NO hay contrato laboral formal.** Es ESQUEMA improvisado de Valeria aprovechando su acceso a Gabriel.
- **Esteban acepta por desesperación**, no por kink declarado. Eso emerge.
- **Valeria descubre su sadismo en el camino** — no estaba planeado. Doble despertar paralelo al de Esteban.
- **Gabriel cogerá a Estefanía SIN saber**. La capa cuckold inverso es central.

---

## 2. Pivotes Narrativos (5)

### Pivote 1 — La presentación del esquema (Cap 1, primera escena)
- **Qué ocurre:** Valeria le explica a Esteban el plan: ella le va a presentar a Gabriel como su amiga "Estefanía" para que Gabriel le dé trabajo. Esteban tiene que aceptar transformarse físicamente, pasar por mujer en oficina, mantener el engaño. Es la única forma de pagar las deudas.
- **Por qué el puesto DEBE ser mujer (justificación interna obligatoria):** Gabriel mantiene un staff cercano **femenino exclusivo** en su agencia porque sus amantes (incluyendo a Valeria) entran y salen del piso con regularidad — un asistente hombre en esa posición rompería la coreografía y levantaría sospechas en su mujer/socios. Es una regla suya, conocida en el círculo, conveniente para Valeria. Esta justificación se planta en boca de Valeria durante la presentación del esquema, y carga retroactivamente la capa cuckold (Gabriel necesita una mujer porque sus amantes — incluida la esposa de Esteban — pasan por ahí).
- **Por qué excita:** La esposa diseñando el esquema con calma de influencer + el marido cediendo por desesperación + el primer beat de excitación involuntaria de Esteban al escuchar el nombre *Estefanía Rivas* en boca de Valeria + la pista temprana ("sus amantes entran y salen") que la cabeza de Esteban no termina de procesar.
...
### Pivote 2 — Transformación Día 1 + Semana de entrenamiento + Noche del babydoll (TODO el Cap 1 — núcleo)
- **Estructura obligatoria del Cap 1 (corregida v0.3, directiva Ama 30/05/2026):**
  - **Día 1 — TRANSFORMACIÓN COMPLETA (escena larga y detallada, NO resumida):** depilación → tucking → sostenes (con relleno) → tanga → medias + liguero → corsé → stilettos → uñas → maquillaje → peluca. **Cada paso es una escena propia con su propio beat erótico** — el cuerpo respondiendo a cada operación de Valeria, traición del cuerpo en cada prenda. Valeria lo sexualiza CONSTANTEMENTE durante cada paso ("qué culo", "los hombres te van a desear", "los pezones te quedan duros", "esa boquita pintada va a obligar a Gabriel a mirarte"). Cierra con el espejo: Estefanía completa por primera vez. NO se puede resumir esta secuencia; el calor está en el detalle de cada operación.
  - **Días 2-6 — SEMANA DE ENTRENAMIENTO (físico + mental):** caminar en stilettos sin caerse, sentarse cruzando las piernas, levantarse sin abrir, agarrar el lápiz/teléfono con uñas largas, voz silenciosa (no hablar más de lo necesario), gestualidad femenina, manera de mirar al hombre. Ejercicios repetidos, Valeria como entrenadora con calma. El cuerpo aprende; la mente resiste y se quiebra en paralelo. Cada día Valeria sigue sexualizándolo ("cuando camines así frente a Gabriel..."). Resistencia que se va astillando, no de golpe.
  - **Día 7 NOCHE — BABYDOLL (CALOR ALTO, escena clímax del Cap 1):** Esteban duerme con tucking + babydoll de seda champagne (el babydoll de Valeria). Valeria lo trata y lo toca como mujer en la cama matrimonial. **Sube MUCHO la temperatura** — no es solo "te toco el pecho falso": Valeria recorre el cuerpo entero, le habla al oído como amante a amante (no como esposa a marido), el cuerpo de Esteban responde plenamente del lado femenino — pezones duros, contracción del culo, humedad/goteo bajo el tucking, gemido femenino, cadera empujando la mano. Valeria lo lleva al borde — quizás lo deja temblando sin venirse (para que despierte mojado y dispuesto el lunes), o lo cruza al orgasmo femenino bajo el tape. Termina la semana con el cuerpo entrenado para que el lunes en la oficina ya responda como mujer.
- **Por qué excita:** **Cada acto de feminización es rito de ingreso a la categoría de Valeria, NO procedimiento técnico.** El detalle de cada operación + la voz de Valeria sexualizando + la respuesta involuntaria del cuerpo en cada paso. El entrenamiento muestra que la cabeza también está siendo reprogramada. La noche cierra con el cuerpo ya hablándole en femenino a Valeria — y Valeria descubriendo cuánto le gusta.
- **Emoción objetivo:** Sumisión voluntaria emergente del marido + sadismo voluntario emergente de la esposa + grieta de placer prohibido reconocida en cada paso + el deseo dirigido (saberse deseable como mujer) instalado antes de Gabriel.
- **Errores fatales:**
  - ❌ **Resumir la transformación del Día 1.** NO. Cada paso es una escena. La depilación dura, el tucking dura, el corsé dura. El calor está en el detalle.
...
### Pivote 4 — Esteban descubre el amorío Valeria-Gabriel (Cap 4)
- **Qué ocurre:** Esteban descubre por casualidad — un mensaje, una foto, un objeto — que Valeria y Gabriel son amantes desde hace tiempo. La capa cuckold se activa retroactivamente. **Esteban entiende que: el hombre que lo cogió como mujer es el amante de su esposa.** Y que su esposa lo sabía desde el principio.
- **Por qué excita:** Carga retroactiva sobre todo lo anterior. Cuckold inverso explícito. Esteban es la amante secreta del amante de su esposa, sin que el amante sepa, y la esposa orquestó todo.
- **Emoción objetivo:** Devastación + excitación devastada + reconocimiento de que ya no hay vuelta atrás.
- **Error fatal:** Histeria, drama, salida de personaje. NO. Esteban registra. El escudo burocrático falla por completo. Pero el cuerpo no se rebela — el cuerpo lo asume.
...
### Valeria
- **Rol narrativo:** esposa-influencer descubriendo su sadismo + arquitecta del esquema + amante de Gabriel desde antes.
...
- Posibles amigos de la pareja en el círculo social — figurantes que no saben.
...
1. **La bata de seda champagne** que Valeria usa los sábados, ahora puesta a Esteban. La MISMA seda.
2. **El pulgar de Gabriel sobre el esmalte burdeos** de las uñas de Estefanía. Caricia sin saber.
...
verga · coño · culo · mojada · coger · abrir · weón · departamento · mina · perra · gemir · contraerse · doblar (la verga bajo el tape) · cera · esmalte · bata · medias · pubis · ingles · escroto · perineo · plata (dinero) · trabajar (con sentido específico cuando Valeria lo dice de Esteban → trabajar de Estefanía)

NO usar: polla · joder · follar · tío · móvil · coche · piso · ordenador · sexo (sustantivo genérico — usar verga/coño/culo específico).

---

## 8. Cementerio (lo que NO debe hacer el Escritor)

- ❌ **Convertir el esquema en contrato formal.** No bufetes, no cláusulas, no abogados. Es ESQUEMA improvisado de Valeria en el living de la casa.
- ❌ **BDSM con Gabriel.** Es asimetría sexual hetero. Gabriel seduce como cualquier hombre seduce a una mujer.
- ❌ **Catálogo técnico en la depilación/tucking/sostenes.** Es rito de ingreso a la categoría femenina, no procedimiento médico.
- ❌ **Metadata visible al lector** (la autoverificación, los M1-M17, los conteos van a archivo SEPARADO en `reportes/`). El archivo del capítulo es PROSA PURA.
