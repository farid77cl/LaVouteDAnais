...
| H33 | 🥁 **El beat** que no cambia nunca debajo de la música. Nadie lo menciona | ✅ **Cap 1** (a plantar en v0.2) | por escribir | Se le queda puesto fuera del local (Cap 2 en adelante) y **es el vehículo de la voz**. ⛔ Nunca se explica |
| H32 | 🥤 **El vaso de las chicas.** Se lo dan el primer día, con cariño. Nunca se nombra qué es | ✅ **Cap 1** (a plantar en v0.2) | por escribir | Se lo sirve sola (Cap 3) · se lo pasa a la chica nueva (Cap 6) · pregunta por él en el **Cap 8** y ⛔ **la respuesta no la salva** |
