...
- **🗣️ Motor nuevo: el otro yo** (`canon_relato.md` §6c) — voz interna que pide, **siempre fuera del turno**. Y **🥤 el vaso** (§6b-bis), que existe y **jamás se confirma**.
...
| H31 | 🗣️ **El otro yo.** Un pensamiento de más, en su propia sintaxis, **siempre fuera del turno**. Nunca marcado, nunca reconocido como ajeno | Cap 2 (~Día 45) | plantado | Escala en cuatro estados (objetos → miradas → cuerpo → silencio). **El silencio de los Caps 8-9 es el pago** |
