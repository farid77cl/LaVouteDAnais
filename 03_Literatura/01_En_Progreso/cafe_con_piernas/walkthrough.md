...
| 2 · Escritura | `capitulo_01_el_turno_de_prueba_v0.5.md` | ✅ **05/08/2026 — Cap 1 v0.5, reescritura TOTAL.** La Ama leyó v0.4 y lo repudió en duro: *"300 líneas y cero erotismo... esto es la Antártica, temperatura -40... segunda regla, es un relato de control mental!!!"*. v0.5 comprime el raconto completo (llamada, 142 días, capturas, visita, confrontación) a 3 párrafos + 1 línea de diálogo, corrige el vestuario (Javiera de prueba en minifalda; compañeras contratadas en el uniforme real — microbikini/tiras entrepierna-pechos-cuello, día temático), muestra el aroma+beat actuando de forma progresiva y perceptible sobre el cuerpo/cabeza de Javiera (siempre atribuido por ella a hambre/cansancio/calor), escribe una escena completa de coqueteo-por-propina, y reparte la densidad erótica en todas las escenas en vez de concentrarla en las puntas. v0.3 y v0.4 archivados en `borradores/capitulo_01/`. Pasada de `HUMANIZADOR.md` corrida sobre el archivo cerrado: LIMPIO en las 9 métricas. Autoverificación en `reportes/capitulo_01/autoverificacion_v0.5.md`. `cronologia.md` actualizada (estado del cuerpo Cap 1, H27).
