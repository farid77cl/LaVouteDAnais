...
- **Qué ocurre:** en el club, el cuerpo ejecuta en el pole lo que Matías pagó dos años de clases sin que la mente lo dirija. Bárbara, tutora del piso, lo toca, lo ajusta, lo calienta distinto al contacto masculino. Sebastián aparece en persona, calmo, con la pluma Montblanc.
- **Por qué excita:** él pagó las clases, ahora él las ejecuta. La obra obedece a la música, no a él. El cobrador no presiona — su quietud es lo que pesa.
- **Emoción objetivo:** traición del propio cuerpo + deseo femenino-femenino sin nombrar + el cobro leído en el cuerpo antes que en la mente.
- **Error fatal:** que la memoria muscular sea anécdota. Beat obligatorio: Dani descubre que SABE algo que nunca aprendió.
- **Ubicación temporal:** entrenamiento a mitad de semana, Cap 2.
