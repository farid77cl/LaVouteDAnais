...
- **Qué ocurre:** primera semana (Episodios 2-7). Le brotan ideas ajenas —cuidarse las uñas, fijarse en los antebrazos de Rodrigo, ablandar sus opiniones— que en segundos le parecen razonables. Se pilla mirando a Rodrigo. Los "beneficios" (duerme increíble, se calma, se cree más seguro) lo amarran. **🆕 Dos hitos físicos del grooming (Ama 01/07 — sin magia corporal, solo conducta): (1) SE DEPILA** — le "nace" depilarse (piernas, pecho, etc.); lo razona como comodidad/limpieza/*"me quedó más regio"*, y el cuerpo lampiño lo hace sentir algo que no nombra. **(2) SU PRIMERA ROPA INTERIOR FEMENINA** — se compra/se pone su **primera prenda interior de mujer** (calzón/tanga femenino); lo justifica (*"es más cómodo", "por probar"*), y le gusta cómo se siente y cómo se ve — una grieta de deseo/placer que archiva mal. Ambos vividos de DÍA, en la cabeza despierta que racionaliza (extrañeza→*"¿por qué no?"*), nunca clínico ni aceptación desde la primera línea.
...
- **Ubicación temporal:** Episodios 2-7 / Semana 1 / Cap 2.

### Pivote 3 — El deseo redirigido (Rodrigo sube al trono)
- **Qué ocurre:** Episodios ~8-14. Lo que Nico llama "respeto" a Rodrigo empieza a no poder dejar de mirarlo, después a querer complacerlo. Rodrigo ocupa el polo de autoridad y deseo, y recibe cada gesto nuevo de Nico como espejo (*"siempre fuiste así, weón"*), cementando el "nunca lo sabe".
- **Por qué excita:** el deseo se instala en mitad de una amistad de años, disfrazado de admiración, mientras el arquitecto lo confirma sin levantar la voz.
- **Emoción objetivo:** calorcito que Nico no ubica + ternura peligrosa + dread (lector).
- **Error fatal:** que Nico nombre el deseo como deseo demasiado pronto. Lo archiva mal (como respeto/admiración) hasta que ya no puede.
- **Ubicación temporal:** Episodios ~8-14 / Semana 2 / Cap 3 (arranca).

### Pivote 4 — El amaneramiento / el cuerpo (todo "porque le nació")
- **Qué ocurre:** Episodios ~15-21. Voz, gesto, cómo cruza las piernas, las manos, diminutivos que se le cuelan — los demás notan, él explica. Se arregla, ropa distinta, **cambia cómo presenta el cuerpo** (arreglo, ropa, cómo lo mueve y lo mira) — **sin magia: el cuerpo no muta, cambia la cabeza que lo habita.** 🆕 **PROGRESIÓN DEL GROOMING (Ama 01/07):** en el Cap 3 ya **usa MAQUILLAJE y MÁS ropa femenina** — escala desde la ropa interior del Cap 2 (calzón/tanga) hacia **maquillaje + prendas femeninas exteriores**, de a poco, cada una razonada como gusto propio ("me queda regio", "por probar") y archivada como natural. Rodrigo entra full al trono, recibe la deferencia como natural y la alimenta. Escala el calor con Rodrigo, sin que Rodrigo fuerce.
...
- **Ubicación temporal:** Episodios ~15-21 / fin Semana 3 / Cap 3 (clímax).

### Pivote 5 — La entrega y el eco (el ciclo)
- **Qué ocurre:** feminización + rendición completas, narradas como autenticidad. Nico organiza su vida alrededor de la aprobación de Rodrigo **como su mujer sumisa doméstica: le hace el aseo, cocina, atiende a las visitas de Rodrigo (les sirve el trago, se porta bien) — recatada afuera, puta con él en privado** — y narra su feminización como liberación. Remate: **le recomienda el podcast a otro** (*"tenís que escucharlo, me cambió la vida"*). Última imagen: aprieta play en el Episodio N, en paz.
- **Por qué excita:** el eco de «La app» — él ya vuelto correa sin saberlo, la rueda que sigue. El horror queda entero con el lector.
- **Emoción objetivo:** paz siniestra + hambre + vértigo del ciclo.
- **Error fatal:** que Nico llegue a saber, o que haya paz redentora limpia. Nunca sabe. Muere convencido de que se descubrió a sí mismo. SIN revelación. Puerta abierta.
- **Ubicación temporal:** Episodio ~28 / fin Semana 4 / Cap 4.
...
- **Invariante:** las ganas de agradar / de ser aprobado. Antes por las minas, después por Rodrigo, al final por quien lo mire. La aprobación le da calor — eso NO cambia, solo se redirige.
...
- **Detalle físico ancla:** los antebrazos / las manos de Rodrigo — lo primero que Nico "nota" sin saber por qué (Episodio ~3). Rodrigo apoyado, tranquilo, ocupando espacio sin esfuerzo; la calma del que ya ganó.
...
> **COCCIÓN LENTA — 4 capítulos anclados a episodios (como «La app»).** El número de episodio ES el termómetro del descenso: el lector mide cuánto cayó Nico por qué episodio va. Cada cap escala un peldaño distinto de la escalera de rendición (pensamientos → amaneramiento → deseo → cuerpo → entrega). Cada cap abre en T° ≥ cierre del anterior; la feminización solo sube. POV único de Nico, viviendo en los DÍAS (las noches = caja negra).

| Cap | Episodios / tiempo | Pivote(s) | Peldaño de la escalera | Mecanismo dominante | Beat de ironía | Cierre / cliffhanger |
|-----|-------------------|-----------|------------------------|---------------------|----------------|----------------------|
| 1 — La recomendación | Ep. 1 / Noche 1 + Mañana 1 | P1 | (pre-escalera) | Rodrigo planta con gancho de ego; Nico escucha dormido; primer pensamiento raro + sueño increíble | Rodrigo recomienda sonriendo, ya sabiendo; Nico agradece | Aprieta play otra vez, feliz. Sembrar que Rodrigo observa. Última línea: "Episodio 2." |
| 2 — Los pensamientos | Ep. 2-7 / Semana 1 | P2 | **1. Pensamientos** | Ideas ajenas que le calzan en segundos; se pilla mirando a Rodrigo; los beneficios lo amarran; **🆕 SE DEPILA** (razonado como comodidad/limpieza) **+ su PRIMERA ROPA INTERIOR FEMENINA** (calzón/tanga, "por probar", le gusta cómo se siente) — grooming sí, cuerpo NO muta | Llama "seguridad" a la calma que en verdad lo ablanda | Primera grieta de deseo mal archivada como admiración. La niega. "Episodio 8." |
| 3 — El amaneramiento | Ep. 8-21 / Semanas 2-3 | P3, P4 | **2. Amaneramiento · 3. Deseo redirigido · 4. Cuerpo** | Voz/gesto/manos ya se notan; **empieza a atender/servir a Rodrigo** (le cocina, lo recibe, se arregla para él — depilación/maquillaje/peinado/ropa, **grooming sí, cuerpo NO muta**); Rodrigo entra full al trono y alimenta la deferencia; escala el calor con Rodrigo | Los demás notan, él explica; para el lector el deseo es innegable, para él *"por fin me entiendo"* | Escena con Rodrigo que descarga; Nico lo vive como autenticidad. "Episodio 22." |
| 4 — La entrega | Ep. ~22-28 / Semana 4 | P4 (cierre), P5 | **5. Entrega** | Feminización + rendición plenas narradas como liberación; **la mujer sumisa doméstica plena: le hace el aseo, atiende a las visitas de Rodrigo, recatada afuera / puta con él**; organiza su vida en torno a la aprobación de Rodrigo | Cree que se descubrió a sí mismo — el lector ve la correa | **Le recomienda el podcast a otro** (*"me cambió la vida"*); aprieta play en el Ep. N, en paz. SIN PAZ para el lector. FIN abierto. |
