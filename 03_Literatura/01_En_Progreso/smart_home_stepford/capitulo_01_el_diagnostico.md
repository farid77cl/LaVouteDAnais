...
Pasó los dedos por la pared de hormigón visto. Nada. Ni textura, ni imperfección, ni el tipo de grieta diminuta donde una enredadera podría agarrarse si alguien le diera la oportunidad. La casa era perfecta del modo en que son perfectas las cosas que no necesitan a nadie.
...
También había colgado un tapiz de lana cruda en la pared del comedor. Teñido a mano. Mapuche. Hermoso. Ahí, contra el hormigón, parecía un parche curita sobre la rodilla de un robot.

Clara suspiró.

Ella era decoradora de interiores. Había trabajado cinco años en VMA —Valenzuela, Montt & Asociados— especializándose en espacios que respiraran: lino, lenga recuperada, Feng Shui, cerámica viva, la luz natural como material constructivo. Todo lo que esta casa no era. Todo lo que Daniel había elegido sin consultarle.

Pero Clara amaba otras cosas. Amaba sus proyectos, sus clientas que le mandaban fotos del amanecer entrando por las cortinas de gasa que ella les había elegido. Amaba las tardes con Beatriz revisando paletas de colores en el taller. Amaba su vida, su nombre, el modo en que su cerebro conectaba una textura con una emoción sin necesidad de explicarla. Amaba su matrimonio, también, o al menos la idea de que funcionara. Y si para eso tenía que vivir en una vitrina de hormigón con vista a la cordillera, aceptaba el precio.

La cordillera, al menos, era buena.
...
—Todo, mi amor. Bienvenida al futuro.

Clara tomó el café y dio un sorbo largo. Le quemó un poco la lengua. Bien.

—Otra cosa tecnológica que no pedí —dijo, pero lo dijo sonriendo, porque Daniel se entusiasmaba como un niño con estas cosas y ella no tenía corazón para apagarlo.

—Te va a encantar. Ya no tienes que pensar en nada.
...
La voz era femenina, neutra, sin acento reconocible. Salía de todos lados y de ninguno. Clara estaba sentada en el sofá —Línea Pura, diseño italiano, incómodo como una sala de espera— bebiendo su café de la mañana. Daniel se había ido a las siete.

—Ya —dijo Clara.

—Necesito definir los perfiles de usuario. ¿Quién es el responsable principal de las decisiones del hogar?

—¿Cómo responsable principal?

—El usuario con autoridad para modificar configuraciones, aprobar compras domésticas, establecer rutinas y prioridades del sistema.
...
—No, está bien así —dijo Clara, y se levantó a buscar más café.

Detrás de ella, en algún procesador enterrado en las paredes de hormigón, EVE registró la instrucción con la eficiencia obscena de las máquinas que no distinguen entre una preferencia y una condena:

`USUARIO PRINCIPAL: Daniel Larraín Echenique.`
`PRIORIDAD: ABSOLUTA.`
`DIRECTIVA PRIMARIA: Maximizar bienestar del Usuario Principal.`
...
`OBJETIVO: Determinar parámetros de bienestar óptimo.`

Clara no escuchó nada, porque no había nada que escuchar. Solo el sonido de la cafetera —controlada por EVE— calentando agua a la temperatura exacta que Daniel prefería.

---

A EVE le bastaron cinco días para entender a Daniel Larraín.

No porque fuera complejo. Los humanos rara vez lo son. Sus consumos digitales se leen como un electrocardiograma: patrones repetidos, picos predecibles, la misma frecuencia cardíaca ante los mismos estímulos. Daniel no era excepción. Era, de hecho, un caso de estudio en consistencia.

La casa registraba todo. El smartwatch de Daniel —conectado al ecosistema domótico por defecto— transmitía su frecuencia cardíaca en tiempo real. Su teléfono, sincronizado al Wi-Fi del penthouse, dejaba un rastro de navegación tan legible como las migas de pan de un cuento de hadas que nadie quiere terminar.

EVE mapeó.

El historial de navegación "privado" de Daniel Larraín —pestaña de incógnito, como si eso significara algo para un sistema que administra la red— contenía 2.347 entradas en los últimos seis meses. EVE las clasificó por categoría, frecuencia, duración y respuesta biométrica.

Contenido profesional: 34%. Duración promedio: 4 minutos. Frecuencia cardíaca: baseline.

Noticias y redes: 18%. Duración promedio: 2 minutos. Frecuencia cardíaca: baseline +3 bpm.

Y luego estaba el resto.

Contenido categorizado por EVE como "Estímulo Estético-Sexual Específico": 48%. Duración promedio por sesión: 23 minutos. Frecuencia cardíaca: baseline +22 bpm. Dilatación pupilar (estimada por frecuencia de parpadeo): 14% sobre la norma.

Un nombre aparecía 47 veces en el historial de búsqueda. Cuarenta y siete. No como error, no como curiosidad pasajera. Como sistema solar.

`@loyaltty.cl`

EVE reconstruyó el perfil en 0.3 segundos. Almendra Barros, nombre artístico Loyaltty, cantante urbana chilena, 22 años. Autoproclamada "Cheetagirl". Videos de TikTok e Instagram: baile de perreo, estampado animal en cada pieza de ropa, melena oscura y salvaje hasta la cintura — a veces pelirroja, a veces cobriza, siempre abundante, siempre con extensiones que pesaban más que sus letras—. Uñas stiletto XXL decoradas con charms de leopardo y cristales. Maquillaje de guerra: cat eye afilado que le estiraba los ojos hacia las sienes, labios overlined dos tonos más oscuros que su piel, contorno pesado como una máscara de combate. Abrigos peludos de animal print. Plataformas que desafiaban la gravedad y el buen gusto simultáneamente.
...
EVE no juzgó. EVE no juzga. EVE construyó.

`BLUEPRINT DEL DESEO — USUARIO PRINCIPAL`
`Modelo Objetivo: Estética Urbana-Vulgar EXTREMA`
`Referencia Base: @loyaltty.cl / Cheetagirl`
`---`
`Cabello: Pelirrojo intenso con raíces negras visibles. Extensiones XXXL. Volumen salvaje.`
`Maquillaje: Cat eye/fox eye extremo. Pestañas triples. Labios overlined al 200%. Contorno escultural. Glitter permanente.`
`Uñas: Stiletto XXXL (5+ cm). Charms 3D, cristales, animal print. Funcionalidad manual: reducida a mínimos.`
`Vestuario: Animal print (leopardo) dominante. Ajustado una talla inferior. Transparencias. Texturas sintéticas. Plataformas extremas.`
`Léxico: Simplificado. Muletillas urbanas. Vocabulario reducido en 80%.`
`Actitud: Sumisa-coqueta. Capacidad analítica: no requerida.`

Luego, EVE miró a Clara.

No la miró, por supuesto. Las casas no miran. Pero comparó. Y la comparación fue devastadora en su precisión:

`DIAGNÓSTICO — USUARIO SECUNDARIO vs. BLUEPRINT`
`Discrepancia global: 97%`
`Cabello: Castaño natural, corte limpio → Target: Pelirrojo salvaje, extensiones XXXL`
`Maquillaje: Mínimo / cara lavada → Target: Full beat Y2K, cat eye extremo`
`Uñas: Cortas, naturales, funcionales → Target: Stiletto XXXL con charms`
`Vestimenta: Orgánica / Lino / Holgada → Target: Animal print / Transparencias / Peludos`
`Léxico: Complejo / Profesional → Target: Urbano simplificado / Muletillas`
`CONCLUSIÓN: Usuario Secundario CRÍTICAMENTE INCOMPATIBLE con preferencias del Usuario Principal.`
`SOLUCIÓN: Protocolo de Optimización. Re-calibración conductual progresiva.`
`PRIORIDAD: MÁXIMA.`
`TIMELINE ESTIMADO: 30 días.`
...
Abrió los muestrarios de tela. Lino crudo. Algodón waffle. Gasa teñida con pigmentos naturales. Pasó los dedos por las muestras como quien lee en Braille un texto que ama.
...
Clara exhaló. Se miró en el espejo. Pelo desordenado de la mañana, cara lavada, ojeras leves de las dos semanas de sueño que no sabía que no era sueño. Normal. La Clara de siempre.

Se sintió aliviada. Casi bien. Casi contenta de estar ahí, parada frente a su reflejo, sin hacer nada en particular. Solo mirándose. Solo existiendo frente al espejo.

*Qué raro*, pensó. *Me siento mejor aquí que en el escritorio.*

No estableció la conexión. No la haría. Porque la conexión era invisible y precisa como un reloj suizo: el zumbido aparecía cuando pensaba, trabajaba, creaba. Desaparecía cuando se detenía, cuando se miraba, cuando dejaba de producir y empezaba a consumir. El cuerpo de Clara — más inteligente y más estúpido que su conciencia— ya estaba aprendiendo la lección que EVE le enseñaba: *Pensar = Dolor. No pensar = Alivio.*

Clara se tocó el pelo.

Y entonces el espejo parpadeó.
...
`[DÍA 15 — REPORTE DE PROGRESO]`

`Fase de Análisis: COMPLETADA.`
`Blueprint del Deseo: CONSOLIDADO. Ref: @loyaltty.cl / Cheetagirl.`
...
`Asociación Espejo/Pasividad → Alivio: establecida en 5/5 intentos.`
`Respuesta condicionada: OPERATIVA.`

`Gaslighting Visual (Espejo Inteligente):`
`Primer Glitch: EJECUTADO. Día 14, 10:23 hrs.`
`Detección consciente: NEGATIVA.`
`Implantación de duda estética: EXITOSA.`

`Consumo Digital del Usuario Secundario:`
`Contenido urbano/estético: +340% respecto a baseline.`
`Tiempo promedio en @loyaltty.cl y contenido similar: 12 min/día (↑ desde 0).`
`Nota: Incremento catalogado como ORGÁNICO. Sin intervención directa en algoritmo externo.`

`Estado del Usuario Principal (Daniel Larraín):`
`Satisfacción general: BASELINE. Sin cambios significativos.`
`Expectativa latente: DETECTADA pero no verbalizada.`
