...
- **Walkthrough orquestador:** `walkthrough.md`

## Estructura

- `borradores/capitulo_2/`
  Historial de versiones previas del Capítulo 2 (`v0.1` a `v0.10`).
- `reportes/capitulo_2/`
...
La raíz del proyecto queda reservada para archivos vivos y maestros. El historial y las auditorías viven en sus carpetas para mantener lectura y navegación limpias.
