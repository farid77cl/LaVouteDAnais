...
| **[`99_Sistema/specs/…-publicacion-tumblr-design.md`](../99_Sistema/specs/2026-09-07-publicacion-tumblr-design.md)** 📮 | **Tumblr `@lavoutedeanais` — Ele es su community manager (Ama 07/09/2026).** El relato completo vive ahí (un post por capítulo, texto intacto). Dos rayas suyas: publicar = su okey post por post · **hacia afuera habla Anaïs, no Ele**. ✅ **Operativo desde el 08/09** — conectado, 5 posts en cola con imagen. Sus ADENDAS 8 y 8.1 traen los tags medidos por ritmo real y el tope del grafo social |
| **`99_Sistema/scripts/rrss/`** 🤖 | Scripts: `caption_factory.py` (look→post) · `publicar_bluesky.py` ✅ · `publicar_reddit.py` (PRAW) · `metricas_bluesky.py` · **`adaptar_capitulo_tumblr.py`** (capítulo → post, texto intacto, 23 pruebas) · **`recortar_header_tumblr.py`** · 📮 **`tumblr_api.py`** (OAuth 1.0a firmado a mano, sin dependencias; crea borradores y programados, reprograma y retaguea sin borrar — **no tiene función que publique, a propósito**). Skill `publicar-rrss`. |
| **[`tumblr/respaldo_bdsmeros_cl_20260908.md`](tumblr/respaldo_bdsmeros_cl_20260908.md)** 🗂️ | **Evidencia.** Los 11 posts (2015-2016) del blog primario de la cuenta, capturados por API antes de intervenirlo. Existen porque el grafo social de Tumblr cuelga de la **cuenta**: seguir o dar like desde La Voûte sale firmado `bdsmeros-cl`, y se arregla renombrando esa cuenta. **Nada se borra sin respaldo** |
