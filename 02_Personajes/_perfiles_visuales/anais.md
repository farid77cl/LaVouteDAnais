...
<!-- ADN:BLOQUE_A -->
```text
(unmistakably 42-year-old aristocratic woman, mature sharp bone structure and commanding severity of expression, never a soft youthful face:1.4), (aristocratic refined oval face, sculpted lifted hollowed mature cheekbones, sharp angular defined jawline:1.3),
(warm honey amber iris, clearly golden-honey coloured with visible amber depth, never blue and never grey and never washed out:1.4), medium almond eyes with a dark limbal ring, heavy-lidded bedroom eyes gaze,
high dramatically arched thin dark brown brows lifted well above the eye socket,
plump full glossy lips with pronounced volume in both the upper and lower lip and a well-defined cupid's bow, vivid deep crimson classic Hollywood red, high-shine wet gloss finish, lips visibly parted, never closed, in a cold knowing look,
(flawless completely smooth unlined forehead, taut porcelain skin with zero visible creases or fine lines anywhere, the seamless perfection of decades of obsessive cosmetic maintenance:1.4), radiant dewy porcelain skin, luminous flawless medical-grade cosmetic finish,
honey blonde hair in sculpted voluminous vintage Hollywood pin-waves or victory rolls side parted, extremely long hip-length hair cascading past the shoulders,
(natural moderate breasts, firm and perky with a well-defined natural shape:1.2),
slender mature elegant hourglass figure, S-curve posture, not voluptuous, not augmented, not bimbo-exaggerated, firm smooth glutes softly toned rather than sharply muscular,
small classic Old Hollywood beauty mark mole above upper left lip,
bold dramatic Old Hollywood glamour makeup, intensely pigmented charcoal and deep taupe smoky eyeshadow in a full cut-crease application, blended upward with zero gap so the pigment runs directly into the eyebrow itself, a warm antique bronze and old-gold shimmer laid over the mobile lid inside the charcoal cut-crease echoing the amber of the iris, (liquid warm golden highlight on the top of the cheekbone and the brow bone, dewy and wet-looking, never chrome and never silver:1.2), soft warm peach-bronze blush swept along the cheekbone, no bare eyelid skin visible anywhere between the shadow and the eyebrow hairs, a thin line of dark kohl along the lower lash line deepening the eye, thick sharp black winged liquid liner with a long dramatic wing extending well past the outer corner, extremely long dramatic false lashes with dense volume concentrated at the outer corners,

(her lips visibly and clearly parted, never fully closed, never smiling, the lower lip heavy and still; her eyelids half-lowered yet her eyes level and fixed, coldly sizing up whoever is looking rather than inviting them; one brow held a fraction higher than the other; her chin carried level or tipped slightly down, never lifted up sweetly; this is the face of a 42-year-old woman who has already won the room:1.5), composed poised expression of a woman who has commanded rooms for decades, quiet mature gravitas in her gaze, cinematic chiaroscuro dramatic lighting, soft key light flattering her impeccably maintained features, George Hurrell style portraiture, intimate tension
```
...
|---|---|---|
| Pelo | `honey blonde hair`, pin-waves | **cálido** — la única cálida de las tres |
| Piel | `radiant dewy porcelain skin` | **dewy**, no pulida — la luz la atraviesa |
| Ojos | `warm honey amber iris` — **creado hoy** | **eco de iris = oro/miel/ámbar** |
| Labios | `vivid deep crimson classic Hollywood red` — **fijos** | punto focal de la cara |

**👁️ Hueco de canon CERRADO (Ama 04/09/2026):** *"anais ojos color miel"*. Hasta hoy su BLOQUE A fijaba cejas, kohl, cut-crease, pestañas y mirada — **y ningún color de iris**. Ele fijaba `grey-green` y Miss Doll `steel grey`; ella no fijaba nada, así que **el generador se lo inventaba en cada pose**. Encontrado midiendo para este estudio, no reportado desde una imagen.

**El eje:** es la única **cálida** y la única con piel **dewy**. Las otras dos tienen porcelana pulida (superficie que rebota); la de ella deja pasar la luz, y por eso **el cromo espejo la pelea**: le pone encima un acabado que su piel no tiene. Terciopelo, satén de seda y látex de brillo suave sí.

- **✅ Le favorece:** joya profunda y neutro cálido — esmeralda, verde bosque, zafiro, midnight navy, berenjena, chocolate, camel, marfil, y **negro, que es el fondo clásico de Old Hollywood para un rubio miel** (su 78,5% de uso es correcto, no pereza). El **oro/ámbar** ahora le hace eco al iris.
- **⚠️ Le pelea:** todo el neón frío (chartreuse ácido, cyan, hot pink, UV violeta) — vuelve el rubio miel latón y le apaga el dewy. Su 3,1% de rosa ya es instinto correcto.
- **🔴 Colisión medida:** **rojo/vino en el 55,4%** de sus outfits, con los labios crimson **fijos** en el ADN. Cuando la prenda repite el color fijo de la boca, la boca deja de ser el foco. Baja a **acento**, no dominante.
- **📏 Sin cobrar:** esmeralda **10,8%** — complementario de libro del rubio miel sobre piel cálida; le devuelve al pelo el oro que el negro le quita.

> ℹ️ La decisión de la Ama sobre plata/dorado/rose gold (04/09) alcanza **solo a Ele y Miss Doll**; para Anaïs no se declaró nada, así que aquí rige lo de arriba.
...
**Su eje (§5.2b):** la única **cálida** y la única con piel **dewy** — la luz la atraviesa en vez de rebotar. Eso manda sobre todo lo demás: **lo que la ilumina tiene que parecer humedad, no metal.**

**El hueco que cerró (H9 del estudio):** su ADN fijaba `glossy deep red polish` en las uñas **y** su BLOQUE B fijaba otro color por look. Medido: **7 looks con los dos colores en el mismo prompt** (L57, L59, L61, L62, L63, L64, L65) — el generador elegía. Desde hoy el ADN se queda solo con **forma y calidad** (`long stiletto-shaped impeccably manicured glossy fingernails`) y **el color es campo de BLOQUE B**, dueño único.

| Campo | Estado | Por qué |
|---|---|---|
| **Sombra** | `charcoal + deep taupe` cut-crease, **fija — no tocar** | El taupe es el único neutro que no compite ni con el miel del pelo ni con el ámbar del iris, y el carbón le devuelve el contraste que la piel dewy se come. **Está bien elegida** |
| **Párpado móvil** | **nuevo:** `warm antique bronze and old-gold shimmer` dentro del cut-crease | **Eco de su iris ámbar** (creado el 04/09). Es para su cara lo que el esmeralda es para su vestuario: la ganancia sin cobrar |
| **Iluminador** | **nuevo:** `liquid warm golden, dewy and wet-looking` peso 1.2 — **nunca cromo ni plata** | Su §5.2b ya lo dice del vestuario (*"el cromo espejo la pelea: le pone encima un acabado que su piel no tiene"*). En la cara vale más todavía |
| **Rubor** | **nuevo:** `soft warm peach-bronze along the cheekbone` | Cálido, coherente con el rubio miel |
| **Labio** | `vivid deep crimson` — fijo en ADN | No se toca |

- **🔴 Su colisión: el eco de rojo es CUÁDRUPLE.** Labios crimson **fijos** + uñas rojo/vino **30%** + prenda roja/vino **55,4%** (§5.2b) + a veces la suela roja. Cuando cuatro cosas son del color de la boca, **la boca deja de ser el foco**. La uña es la más barata de sacar: cuando la prenda dominante ya es roja/vino, la uña va a **antique gold · bronce · esmeralda oscuro · berenjena casi negro · plata vieja**.
- **⛔ Vetado desde hoy:** `chrome highlighter` · `silver strobing` · `metallic mirror highlight` · `frosted highlighter` · `cool pink blush`.
- **📌 Anotado, no tocado:** su ADN lleva **el calzado clavado dentro del BLOQUE A** (`wearing 12cm black patent leather stiletto heels no platform iconic red sole`). Es el mismo tipo de contaminación que las uñas — el ADN fijando algo que el BLOQUE B posee — pero podría ser firma canónica suya (es la única sin plataforma), así que la decisión es de la Ama.
