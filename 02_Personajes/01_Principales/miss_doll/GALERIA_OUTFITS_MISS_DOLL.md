...
```
- Campos obligatorios §5.5: corsé opcional (ausente, decisión de diseño) · prenda principal (halter vinyl neón) · hardware (correas finas + hebillas cromo) · medias (thigh-high sheer) · calzado con plataforma (5 atributos) · accesorios (choker + body chain) · rosa firma (halter + thong dominante) · **uñas** (coffin chrome hot pink).
...
```
- Campos §5.5: corsé ausente (opcional) · prenda principal (mini vestido vinyl estructurado, moño como pieza de alta costura, no accesorio de pelo infantil) · hardware (cadena de oro fina) · medias (sheer negras) · calzado con plataforma (5 atributos) · accesorios (choker + aros) · rosa firma (vestido dominante) · **uñas** (almond gold-tip hot pink).
