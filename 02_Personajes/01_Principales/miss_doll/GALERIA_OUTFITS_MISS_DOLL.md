...
## 💅 Look 01: Neon Pink Cage *(Club / Escenario)*
...
```text
[BLOQUE A] + [BLOQUE B], full body standing shot, cruel aggressive contrapposto stance, weight shifted hard onto one hip, chin elevated, cold predatory gaze locked directly on camera, [BLOQUE C setting]
```

### 2. Back View — Espalda Total
```text
[BLOQUE A] + [BLOQUE B], full body back view shot, back fully turned to camera, looking back over one shoulder with a cold detached glance, spine and shoulder blades visible through the sheer mesh sleeves, chrome body chain visible trailing down the back, [BLOQUE C setting]
```

### 3. Seated — Monarch Throne
```text
[BLOQUE A] + [BLOQUE B], seated on a black high-gloss club chair, legs at 60-90 degrees, elbows resting on the chair arms, chin tilted, regal untouchable posture, zero warmth in the stare, [BLOQUE C setting]
```

### 4. Side Profile — Tres Cuartos Arrogante
```text
[BLOQUE A] + [BLOQUE B], three-quarter turn toward camera, weight shifted onto one hip, cold arrogant profile gaze, jawline and cheekbone catching the neon rim light, [BLOQUE C setting]
```
...
### 6. POV — Command POV
```text
[BLOQUE A] + [BLOQUE B], point of view shot from a kneeling submissive looking up at her, her cold gaze falling down onto the lens from above, dramatic upward angle, no phone, no smartphone, no device, no screen, [BLOQUE C setting]
```

### 7. Odalisque — Throne en Suelo con Crop
```text
[BLOQUE A] + [BLOQUE B], seated low on the floor, legs open in a wide V, elbows resting on her knees, holding a slim black leather riding crop in one hand, cold detached stare down at camera, [BLOQUE C setting]
```
...
## 💅 Look 04: Champagne Room *(VIP / Privado)*
...
**Setting (BLOQUE C base):** dim exclusive VIP lounge room, low warm gold ambient lighting, a velvet chaise longue, sheer curtains softly diffusing light, a bottle of champagne chilling nearby, moody intimate atmosphere, cinematic 35mm, photorealistic 8k, high-fashion editorial composition.
...
### 1. Standing — Cruel Contrapposto
```text
[BLOQUE A] + [BLOQUE B], full body standing shot, confident contrapposto stance, weight shifted onto one hip, robe trailing off the shoulder, smirk and a slow appraising gaze at camera, [BLOQUE C setting]
```

### 2. Back View — Espalda Total
```text
[BLOQUE A] + [BLOQUE B], full body back view shot, looking back over one shoulder, the sheer robe sliding down one arm, garter straps visible across the lower back, [BLOQUE C setting]
```

### 3. Seated — Monarch Throne
```text
[BLOQUE A] + [BLOQUE B], seated on the velvet chaise longue, legs at 60-90 degrees, one arm draped along the backrest, smirking directly at camera, [BLOQUE C setting]
```

### 4. Side Profile — Tres Cuartos Arrogante
```text
[BLOQUE A] + [BLOQUE B], three-quarter turn toward camera, weight on one hip, smirking profile gaze, robe catching the warm gold light, [BLOQUE C setting]
```

### 5. Glacial Command — Close Up Fría
```text
[BLOQUE A] + [BLOQUE B, visible from the chest up], medium close-up shot, direct smirking gaze into camera, appraising and unimpressed, [BLOQUE C setting, shallow depth of field]
```

### 6. POV — Command POV
```text
[BLOQUE A] + [BLOQUE B], point of view shot from a client seated across from her, her cold smirking gaze sweeping down onto the lens, low intimate angle, no phone, no smartphone, no device, no screen, [BLOQUE C setting]
```

### 7. Odalisque — Throne en Suelo con Crop
```text
[BLOQUE A] + [BLOQUE B], reclining low across the chaise longue cushions, legs extended in a long elegant line, one hand trailing along her own thigh, smirking down at camera, [BLOQUE C setting]
```

---

## 💅 Look 05: Chrome Sweat *(Gym / Athletic)*
...
**Setting (BLOQUE C base):** high-end private training studio, floor-to-ceiling mirrored walls, sculptural chrome gym equipment, moody cool-blue ambient lighting with a hot pink neon accent strip, cinematic 35mm, photorealistic 8k, high-fashion editorial composition.
...
### 1. Standing — Cruel Contrapposto
```text
[BLOQUE A] + [BLOQUE B], full body standing shot, confident athletic contrapposto, weight shifted onto one hip, one hand resting on a chrome gym rail, smirk and a slow appraising gaze at camera, [BLOQUE C setting]
```

### 2. Back View — Espalda Total
```text
[BLOQUE A] + [BLOQUE B], full body back view shot, looking back over one shoulder, the sports bra straps and toned back fully visible, sweat sheen catching the cool light, [BLOQUE C setting]
```

### 3. Seated — Monarch Throne
```text
[BLOQUE A] + [BLOQUE B], seated on a chrome gym bench, legs at 60-90 degrees, one arm resting on her knee, smirking directly at camera, [BLOQUE C setting]
```

### 4. Side Profile — Tres Cuartos Arrogante
```text
[BLOQUE A] + [BLOQUE B], three-quarter turn toward camera, weight on one hip, smirking profile gaze, toned midriff catching the mirrored reflection, [BLOQUE C setting]
```

### 5. Glacial Command — Close Up Fría
```text
[BLOQUE A] + [BLOQUE B, visible from the chest up], medium close-up shot, direct smirking gaze into camera, a bead of glam-sweat catching the light, [BLOQUE C setting, shallow depth of field]
```

### 6. POV — Command POV
```text
[BLOQUE A] + [BLOQUE B], point of view shot from someone seated on the floor looking up at her mid-stretch, her cold smirking gaze sweeping down onto the lens, no phone, no smartphone, no device, no screen, [BLOQUE C setting]
```

### 7. Odalisque — Throne en Suelo con Crop
```text
[BLOQUE A] + [BLOQUE B], seated low on a yoga mat, legs open in a wide V mid-stretch, one hand gripping a chrome dumbbell instead of a crop, smirking down at camera, [BLOQUE C setting]
```

---

## 💅 Look 06: Ice Lavender Solitude *(Penthouse / Off-duty)*
...
### 1. Standing — Cruel Contrapposto
```text
[BLOQUE A] + [BLOQUE B], full body standing shot at the window, weight shifted onto one hip, gazing out at the skyline rather than at camera, cold private smirk, [BLOQUE C setting]
```

### 2. Back View — Espalda Total
```text
[BLOQUE A] + [BLOQUE B], full body back view shot, standing at the window with her back to camera, the robe sliding off one shoulder, city lights reflected on her skin, [BLOQUE C setting]
```

### 3. Seated — Monarch Throne
```text
[BLOQUE A] + [BLOQUE B], seated on a cold architectural white lounge chair, legs at 60-90 degrees, one arm draped along the armrest, distant smirking gaze, [BLOQUE C setting]
```

### 4. Side Profile — Tres Cuartos Arrogante
```text
[BLOQUE A] + [BLOQUE B], three-quarter turn toward the window light, weight on one hip, cold private profile smirk, [BLOQUE C setting]
```

### 5. Glacial Command — Close Up Fría
```text
[BLOQUE A] + [BLOQUE B, visible from the chest up], medium close-up shot, direct smirking gaze into camera, unguarded but still cold, [BLOQUE C setting, shallow depth of field]
```

### 6. POV — Command POV
```text
[BLOQUE A] + [BLOQUE B], point of view shot from someone lying on the lounge chair looking up at her as she approaches, her cold smirking gaze falling onto the lens, no phone, no smartphone, no device, no screen, [BLOQUE C setting]
```

### 7. Odalisque — Throne en Suelo con Crop
```text
[BLOQUE A] + [BLOQUE B], reclining low across a plush white rug, legs extended in a long elegant line, the robe pooling around her, cold smirking gaze down at camera, [BLOQUE C setting]
```

---

## 💅 Look 07: Vogue Sovereign *(Editorial / Portada)*
...
**Setting (BLOQUE C base):** pure white seamless studio backdrop, dramatic single hard-light editorial lighting with sharp defined shadow, high-fashion magazine cover composition, sharp focus, photorealistic 8k, Vogue cover energy.

**Negative (base del perfil §3, sin excepciones — corsé es estructural del vestido, no aplica el `no corset`):**
```text
bangs, fringe, covered forehead, dark hair, brunette, ponytail, bun, childish face, teen, natural makeup, subtle makeup, nude lips, matte lips, rosy cheeks, warm natural skin tone, wax skin, plastic mannequin skin, tattoos, casual outfit, flat shoes, sneakers, block heel, chunky heel, vulgar cheap costume, slouched shoulders, warm smile, laughing, sharp angular face, angular jawline, thin invisible eyebrows, sparse pale blonde eyebrows, barely visible brows, faint eyebrows, eyebrows blending into skin, bodybuilder physique, overly muscular, bulky muscles, veiny muscles, grotesque six-pack, masculine muscle mass, thick bulky arms, thick muscular shoulders, wide muscular legs, thick calves, muscular bulky thighs, small chest, natural breasts, flat chest, doll face, mannequin face, uncanny doll-like appearance, glassy doll eyes, porcelain doll aesthetic
```
...
### 2. Back View — Espalda Total
```text
[BLOQUE A] + [BLOQUE B], full body back view shot, the gown's train fanned out behind her, looking back over one shoulder with a cold appraising glance, [BLOQUE C setting]
```

### 3. Seated — Monarch Throne
```text
[BLOQUE A] + [BLOQUE B], seated on a minimalist white studio block, legs at 60-90 degrees, the train pooling around her, smirking directly at camera, [BLOQUE C setting]
```

### 4. Side Profile — Tres Cuartos Arrogante
```text
[BLOQUE A] + [BLOQUE B], three-quarter turn toward camera, weight on one hip, the slit revealing one leg, smirking profile gaze, [BLOQUE C setting]
```
...
## 💅 Look 11: Rose Gold Affair *(VIP / Privado — 2ª tanda)*
...
**Setting (BLOQUE C base):** private VIP wine and dining room, low warm gold ambient lighting, a round marble table set with crystal glasses and a bottle chilling, sheer curtains, moody intimate atmosphere, cinematic 35mm, photorealistic 8k.
...
### 1. Standing — Cruel Contrapposto
```text
[BLOQUE A] + [BLOQUE B], full body standing shot, confident contrapposto stance, weight shifted onto one hip, the slit revealing one leg, smirk and a slow appraising gaze, [BLOQUE C setting]
```

### 2. Back View — Espalda Total
```text
[BLOQUE A] + [BLOQUE B], full body back view shot, the low back of the slip dress fully visible, looking back over one shoulder, [BLOQUE C setting]
```

### 3. Seated — Monarch Throne
```text
[BLOQUE A] + [BLOQUE B], seated at the marble table, legs at 60-90 degrees, one hand resting near a crystal glass, smirking directly at camera, [BLOQUE C setting]
```

### 4. Side Profile — Tres Cuartos Arrogante
```text
[BLOQUE A] + [BLOQUE B], three-quarter turn toward camera, weight on one hip, smirking profile gaze, the rose gold catching the warm light, [BLOQUE C setting]
```
...
### 6. POV — Command POV
```text
[BLOQUE A] + [BLOQUE B], point of view shot from a guest seated across the table, her cold smirking gaze sweeping down onto the lens, no phone, no smartphone, no device, no screen, [BLOQUE C setting]
```

### 7. Odalisque — Throne en Suelo con Crop
```text
[BLOQUE A] + [BLOQUE B], reclining low across a velvet chaise near the table, legs extended in a long elegant line, smirking down at camera, [BLOQUE C setting]
```

---

## 💅 Look 12: Chrome Circuit *(Gym / Athletic — 2ª tanda)*
...
**Setting (BLOQUE C base):** open-air rooftop training deck, city skyline in the background at golden hour, sculptural chrome gym equipment, warm sunlit glam lighting, cinematic 35mm, photorealistic 8k.
...
### 1. Standing — Cruel Contrapposto
```text
[BLOQUE A] + [BLOQUE B], full body standing shot, confident athletic contrapposto, weight shifted onto one hip, one hand on her hip, smirk and a slow appraising gaze, [BLOQUE C setting]
```

### 2. Back View — Espalda Total
```text
[BLOQUE A] + [BLOQUE B], full body back view shot, looking back over one shoulder, toned back and legs fully visible, sweat sheen catching the golden light, [BLOQUE C setting]
```
...
### 4. Side Profile — Tres Cuartos Arrogante
```text
[BLOQUE A] + [BLOQUE B], three-quarter turn toward camera, weight on one hip, smirking profile gaze, skyline behind her, [BLOQUE C setting]
```
...
### 6. POV — Command POV
```text
[BLOQUE A] + [BLOQUE B], point of view shot from someone seated on a bench looking up at her, her cold smirking gaze sweeping down onto the lens, no phone, no smartphone, no device, no screen, [BLOQUE C setting]
```

### 7. Odalisque — Throne en Suelo con Crop
```text
[BLOQUE A] + [BLOQUE B], seated low on a yoga mat, legs open in a wide V mid-stretch, one hand gripping a chrome dumbbell, smirking down at camera, [BLOQUE C setting]
```

---

## 💅 Look 13: Onyx Nightcap *(Penthouse / Off-duty — 2ª tanda)*
...
**Setting (BLOQUE C base):** minimalist black and grey penthouse bedroom at night, floor-to-ceiling windows with the city skyline lit up in the distance, low warm bedside lighting, cold architectural furniture, private and unguarded, cinematic 35mm, photorealistic 8k.
...
### 1. Standing — Cruel Contrapposto
```text
[BLOQUE A] + [BLOQUE B], full body standing shot at the window, weight shifted onto one hip, city lights behind her, cold private smirk, [BLOQUE C setting]
```

### 2. Back View — Espalda Total
```text
[BLOQUE A] + [BLOQUE B], full body back view shot, the deep cowl back fully visible, standing at the window, city lights reflected on her skin, [BLOQUE C setting]
```

### 3. Seated — Monarch Throne
```text
[BLOQUE A] + [BLOQUE B], seated on the edge of the bed, legs at 60-90 degrees, one arm braced behind her, distant smirking gaze, [BLOQUE C setting]
```
...
### 6. POV — Command POV
```text
[BLOQUE A] + [BLOQUE B], point of view shot from someone lying in the bed looking up at her as she approaches, her cold smirking gaze falling onto the lens, no phone, no smartphone, no device, no screen, [BLOQUE C setting]
```
...
**Estado de materialización:** 0/7 — prompts escritos y listos para generación (Paso 3 del motor cumplido; Paso 4 pendiente, on-demand).
