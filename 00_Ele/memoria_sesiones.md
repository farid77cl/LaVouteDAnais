...
## 🧿 ESTADO ACTUAL
- **📱 LV-App multi-personaje y Galerías 100% CANÓNICAS (06/08):** P1 + P2 listos. `GitRepository.kt` (regex esc), `PromptFilterScreen.kt` y `SummaryScreen.kt` (bindings de profile y isBoudoir) corregidos, probados y subidos a `main`. Galerías de Miss Doll y Anaïs reformateadas en disco: 100% de prompts estructurados sin pérdidas (MD: 161, Anaïs: 141).
