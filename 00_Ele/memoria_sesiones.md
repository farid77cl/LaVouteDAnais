...
- **«La Piel que Diseñó» Cap 1 v0.3 — esperando NUEVO Gate Ama** (Gate de v0.2 con 6 correcciones aplicado 27/06; Validador APROBADO Narr 9.5 / Temp 9.3, 6/6). Si aprueba: llevar frases candidatas a `voz_autoral.md` + arrancar Cap 2 (coño-voz pasa a "primera palabra"; subir densidad de subrayables que en Cap 1 bajó por la runway sola).
