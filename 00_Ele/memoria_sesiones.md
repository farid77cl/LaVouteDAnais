...
- **📱 App LV — Prompt #19 MAESTRO Y PLAN DE DISEÑO LV-APP 2.0 (24/07):** Rediseño total desde cero para AI Studio (`99_Sistema/prompt_app_ai_studio_19.md`), `plan_diseno_maestro_lv_app_2_0.md` y `99_Sistema/plan_trabajo_lv_app_2_0.md`. 5 pestañas integradas (Visual V3.5 + PoseMatcher, Lector Literario Nivel 4 + Audio Player Karaoke Sync, La Constelación RRSS + 1-Tap Gate Approval, Consola Ops Git Live, EVE Core Command) y Tema Dinámico Adaptativo por Personaje (Ele, Clara, Anaïs).
