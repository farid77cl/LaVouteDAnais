...
- **📮 Tumblr @lavoutedeanais — DISEÑADO, sin construir.** Dos specs en `99_Sistema/specs/`: [ilustración](../99_Sistema/specs/2026-09-07-ilustracion-relatos-design.md) (portada por relato + 2 por capítulo, personaje con biblia, PG-13, sin texto) y [publicación + misión viral](../99_Sistema/specs/2026-09-07-publicacion-tumblr-design.md) (relato completo, un post por capítulo, texto intacto, n8n como runtime). Estilo con dueño: `01_Canon/Guias_Especializadas/estilo_comic_pop_v1.md`. **Bloqueado por 5 cosas suyas** (§8 del spec): si `bdsmeros-cl` es suya · Funnel solo publica `/mcp` · credencial n8n en 401 · OAuth de Tumblr · token de GitHub.
- **🧪 Bisección del filtro L80: las 5 variantes generaron**, control incluido, 669×1200 real. Un pase **no** refuta 7 rebotes — la cláusula no es bloqueador determinista, pero con n=1 no se distingue umbral de varianza. Detalle: regla 09. 🐛 La app estampa `[gallery 0x0]` con imágenes full-res: el sello de verificación del 20/07 quedó ciego.
