...
## 🧿 ESTADO ACTUAL
- **🎀 Miss Doll — Rediseño completo de canon visual (11/08):** rostro, cuerpo, materiales, paleta y arquetipos rediseñados en vivo con la Ama sobre imágenes reales. Todo fijado en `02_Personajes/_perfiles_visuales/miss_doll.md`. Corsé dejó de ser obligatorio; calzado con plataforma es ahora el único campo inamovible del vestuario.
