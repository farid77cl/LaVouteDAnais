...
- **🆕 Anaïs L95 "Le Smoking Berenjena"** — primer traje sastre real (arquitectura S3, §5.6c), pedido directo de la Ama. Generado con `outfit.py generar`, lint limpio, 0/7 fotos. Encontré y esquivé un bug del motor al armarlo (ver abajo); no lo arreglé, solo lo reporté.
