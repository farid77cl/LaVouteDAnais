# Canon Visual — La Voûte d'Anaïs

*Reglas para la generación de imágenes y representación visual de personajes.*

---

## 🎨 Principios Generales

1. **Consistencia ante todo** — Cada personaje tiene un look definido que debe mantenerse
2. **Estilo fotográfico** — Preferencia por estética de fotografía de moda/editorial
3. **Sin CGI obvio** — Los personajes deben parecer humanos reales (excepto Miss Doll que es "muñeca viviente")
4. **Tacones siempre** — Ningún personaje femenino aparece sin tacones altos
